  ...
  theme: {
    extend: {
      colors: {
        ...
        "nexus-bg": "rgb(var(--nexus-bg-rgb) / <alpha-value>)",
        "nexus-surface": "rgb(var(--nexus-surface-rgb) / <alpha-value>)",
        "nexus-text": "rgb(var(--nexus-text-rgb) / <alpha-value>)",
        "nexus-muted": "rgb(var(--nexus-muted-rgb) / <alpha-value>)",
        "nexus-cyan": "rgb(var(--nexus-cyan-rgb) / <alpha-value>)",
        "nexus-pink": "rgb(var(--nexus-pink-rgb) / <alpha-value>)",
        "nexus-gold": "rgb(var(--nexus-gold-rgb) / <alpha-value>)",
        "nexus-blue": "rgb(var(--nexus-blue-rgb) / <alpha-value>)",
        "nexus-purple": "rgb(var(--nexus-purple-rgb) / <alpha-value>)",
      },
      fontFamily: {
        sans: ["var(--font-nexus-display)", "var(--font-lexend)", "system-ui", "-apple-system", "Segoe UI", "sans-serif"],
        mono: ["var(--font-nexus-mono)", "ui-monospace", "SFMono-Regular", "Menlo", "monospace"],
        arcade: ["var(--font-nexus-arcade)", "var(--font-nexus-mono)", "monospace"],
      },
