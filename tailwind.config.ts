  ...
  theme: {
    extend: {
      colors: {
        ...
        "diana-navy": "rgb(var(--diana-navy-rgb) / <alpha-value>)",
        "diana-surface": "rgb(var(--diana-surface-rgb) / <alpha-value>)",
        "diana-text": "rgb(var(--diana-text-rgb) / <alpha-value>)",
        "diana-muted": "rgb(var(--diana-muted-rgb) / <alpha-value>)",
        "diana-blue": "rgb(var(--diana-blue-rgb) / <alpha-value>)",
        "diana-pink": "rgb(var(--diana-pink-rgb) / <alpha-value>)",
      },
      fontFamily: {
        sans: ["var(--font-body)", "var(--font-lexend)", "system-ui", "-apple-system", "Segoe UI", "sans-serif"],
