...
- Verified release-candidate preview: deployment `dpl_DX3QVYYpakZoN7cftNjcguY3nQjG` at `https://diana-butsqx6w3-teamcarrillo405-hubs-projects.vercel.app`; Vercel built all 85 pages from commit `9d709f486aa3870228b5888af5dca3defa62339a`, `/api/readiness` passed configuration, Auth, database, and storage probes, and an invalid cron bearer returned JSON 401.
