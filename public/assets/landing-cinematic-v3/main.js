...
`)}var _b={[Ff]:"Linear",[Of]:"Reinhard",[Bf]:"Cineon",[Jo]:"ACESFilmic",[zf]:"AgX",[Vf]:"Neutral",[kf]:"Custom"};function xb(r,e){let t=_b[e];return t===void 0?(tt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Yu=new G;function vb(){mt.getLuminanceCoefficients(Yu);let r=Yu.x.toFixed(4),e=Yu.y.toFixed(4),t=Yu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+g);let M=S+p+a,x=S+g+o,C=xg(i,i.VERTEX_SHADER,M),E=xg(i,i.FRAGMENT_SHADER,x);i.attachShader(_,C),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(A){if(r.debug.checkShaderErrors){let I=i.getProgramInfoLog(_)||"",z=i.getShaderInfoLog(C)||"",H=i.getShaderInfoLog(E)||"",D=I.trim(),F=z.trim(),U=H.trim(),Y=!0,ee=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,C,E);else{let L=yg(i,C,"vertex"),le=yg(i,E,"fragment");nt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,Qb=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],jb=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],Cg=new Nt,sl=new G,cd=new G;function e1(r,e,t){let n=new La,i=new Ee,s=new Ee,a=new Gt,o=new Gc,l=new Wc,c={},u=t.maxTextureSize,d={[yr]:Yn,[Yn]:yr,[Bt]:Bt},h=new en({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ee},radius:{value:4}},vertexShader:$b,fragmentShader:Kb}),f=h.clone();f.defines.HORIZONTAL_PASS=1;let m=new an;m.setAttribute("position",new sn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new gt(m,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zo;let g=this.type;this.render=function(E,w,y){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||E.length===0)return;this.type===ym&&(tt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Zo);let b=r.getRenderTarget(),P=r.getActiveCubeFace(),A=r.getActiveMipmapLevel(),I=r.state;I.setBlending(nr),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let z=g!==this.type;z&&w.traverse(function(H){H.material&&(Array.isArray(H.material)?H.material.forEach(D=>D.needsUpdate=!0):H.material.needsUpdate=!0)});for(let H=0,D=E.length;H<D;H++){let F=E[H],U=F.shadow;if(U===void 0){tt("WebGLShadowMap:",F,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;i.copy(U.mapSize);let Y=U.getFrameExtents();i.multiply(Y),s.copy(U.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/Y.x),i.x=s.x*Y.x,U.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/Y.y),i.y=s.y*Y.y,U.mapSize.y=s.y));let ee=r.state.buffers.depth.getReversed();if(U.camera._reversedDepth=ee,U.map===null||z===!0){if(U.map!==null&&(U.map.depthTexture!==null&&(U.map.depthTexture.dispose(),U.map.depthTexture=null),U.map.dispose()),this.type===ka){if(F.isPointLight){tt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}U.map=new bn(i.x,i.y,{format:os,type:gi,minFilter:Ot,magFilter:Ot,generateMipmaps:!1}),U.map.texture.name=F.name+".shadowMap",U.map.depthTexture=new br(i.x,i.y,Gi),U.map.depthTexture.name=F.name+".shadowMapDepth",U.map.depthTexture.format=Qi,U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=Mn,U.map.depthTexture.magFilter=Mn}else F.isPointLight?(U.map=new Zu(i.x),U.map.depthTexture=new Uc(i.x,Hi)):(U.map=new bn(i.x,i.y),U.map.depthTexture=new br(i.x,i.y,Hi)),U.map.depthTexture.name=F.name+".shadowMap",U.map.depthTexture.format=Qi,this.type===Zo?(U.map.depthTexture.compareFunction=ee?Xu:Wu,U.map.depthTexture.minFilter=Ot,U.map.depthTexture.magFilter=Ot):(U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=Mn,U.map.depthTexture.magFilter=Mn);U.camera.updateProjectionMatrix()}let L=U.map.isWebGLCubeRenderTarget?6:1;for(let le=0;le<L;le++){if(U.map.isWebGLCubeRenderTarget)r.setRenderTarget(U.map,le),r.clear();else{le===0&&(r.setRenderTarget(U.map),r.clear());let Me=U.getViewport(le);a.set(s.x*Me.x,s.y*Me.y,s.x*Me.z,s.y*Me.w),I.viewport(a)}if(F.isPointLight){let Me=U.camera,Ne=U.matrix,ke=F.distance||Me.far;ke!==Me.far&&(Me.far=ke,Me.updateProjectionMatrix()),sl.setFromMatrixPosition(F.matrixWorld),Me.position.copy(sl),cd.copy(Me.position),cd.add(Qb[le]),Me.up.copy(jb[le]),Me.lookAt(cd),Me.updateMatrixWorld(),Ne.makeTranslation(-sl.x,-sl.y,-sl.z),Cg.multiplyMatrices(Me.projectionMatrix,Me.matrixWorldInverse),U._frustum.setFromProjectionMatrix(Cg,Me.coordinateSystem,Me.reversedDepth)}else U.updateMatrices(F);n=U.getFrustum(),x(w,y,U.camera,F,this.type)}U.isPointLightShadow!==!0&&this.type===ka&&S(U,y),U.needsUpdate=!1}g=this.type,p.needsUpdate=!1,r.setRenderTarget(b,P,A)};function S(E,w){let y=e.update(_);h.defines.VSM_SAMPLES!==E.blurSamples&&(h.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new bn(i.x,i.y,{format:os,type:gi})),h.uniforms.shadow_pass.value=E.map.depthTexture,h.uniforms.resolution.value=E.mapSize,h.uniforms.radius.value=E.radius,r.setRenderTarget(E.mapPass),r.clear(),r.renderBufferDirect(w,null,y,h,_,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,r.setRenderTarget(E.map),r.clear(),r.renderBufferDirect(w,null,y,f,_,null)}function M(E,w,y,b){let P=null,A=y.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(A!==void 0)P=A;else if(P=y.isPointLight===!0?l:o,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let I=P.uuid,z=w.uuid,H=c[I];H===void 0&&(H={},c[I]=H);let D=H[z];D===void 0&&(D=P.clone(),H[z]=D,w.addEventListener("dispose",C)),P=D}if(P.visible=w.visible,P.wireframe=w.wireframe,b===ka?P.side=w.shadowSide!==null?w.shadowSide:w.side:P.side=w.shadowSide!==null?w.shadowSide:d[w.side],P.alphaMap=w.alphaMap,P.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,P.map=w.map,P.clipShadows=w.clipShadows,P.clippingPlanes=w.clippingPlanes,P.clipIntersection=w.clipIntersection,P.displacementMap=w.displacementMap,P.displacementScale=w.displacementScale,P.displacementBias=w.displacementBias,P.wireframeLinewidth=w.wireframeLinewidth,P.linewidth=w.linewidth,y.isPointLight===!0&&P.isMeshDistanceMaterial===!0){let I=r.properties.get(P);I.light=y}return P}function x(E,w,y,b,P){if(E.visible===!1)return;if(E.layers.test(w.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&P===ka)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,E.matrixWorld);let z=e.update(E),H=E.material;if(Array.isArray(H)){let D=z.groups;for(let F=0,U=D.length;F<U;F++){let Y=D[F],ee=H[Y.materialIndex];if(ee&&ee.visible){let L=M(E,ee,b,P);E.onBeforeShadow(r,E,w,y,z,L,Y),r.renderBufferDirect(y,null,z,L,E,Y),E.onAfterShadow(r,E,w,y,z,L,Y)}}}else if(H.visible){let D=M(E,H,b,P);E.onBeforeShadow(r,E,w,y,z,D,null),r.renderBufferDirect(y,null,z,D,E,null),E.onAfterShadow(r,E,w,y,z,D,null)}}let I=E.children;for(let z=0,H=I.length;z<H;z++)x(I[z],w,y,b,P)}function C(E){E.target.removeEventListener("dispose",C);for(let y in c){let b=c[y],P=E.target.uuid;P in b&&(b[P].dispose(),delete b[P])}}}function t1(r,e){function t(){let O=!1,ge=new Gt,re=null,Ae=new Gt(0,0,0,0);return{setMask:function(ye){re!==ye&&!O&&(r.colorMask(ye,ye,ye,ye),re=ye)},setLocked:function(ye){O=ye},setClear:function(ye,ue,me,Se,qe){qe===!0&&(ye*=Se,ue*=Se,me*=Se),ge.set(ye,ue,me,Se),Ae.equals(ge)===!1&&(r.clearColor(ye,ue,me,Se),Ae.copy(ge))},reset:function(){O=!1,re=null,Ae.set(-1,0,0,0)}}}function n(){let O=!1,ge=!1,re=null,Ae=null,ye=null;return{setReversed:function(ue){if(ge!==ue){let me=e.get("EXT_clip_control");ue?me.clipControlEXT(me.LOWER_LEFT_EXT,me.ZERO_TO_ONE_EXT):me.clipControlEXT(me.LOWER_LEFT_EXT,me.NEGATIVE_ONE_TO_ONE_EXT),ge=ue;let Se=ye;ye=null,this.setClear(Se)}},getReversed:function(){return ge},setTest:function(ue){ue?fe(r.DEPTH_TEST):ve(r.DEPTH_TEST)},setMask:function(ue){re!==ue&&!O&&(r.depthMask(ue),re=ue)},setFunc:function(ue){if(ge&&(ue=jm[ue]),Ae!==ue){switch(ue){case gc:r.depthFunc(r.NEVER);break;case _c:r.depthFunc(r.ALWAYS);break;case xc:r.depthFunc(r.LESS);break;case Ps:r.depthFunc(r.LEQUAL);break;case vc:r.depthFunc(r.EQUAL);break;case yc:r.depthFunc(r.GEQUAL);break;case Sc:r.depthFunc(r.GREATER);break;case Mc:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Ae=ue}},setLocked:function(ue){O=ue},setClear:function(ue){ye!==ue&&(ye=ue,ge&&(ue=1-ue),r.clearDepth(ue))},reset:function(){O=!1,re=null,Ae=null,ye=null,ge=!1}}}function i(){let O=!1,ge=null,re=null,Ae=null,ye=null,ue=null,me=null,Se=null,qe=null;return{setTest:function(de){O||(de?fe(r.STENCIL_TEST):ve(r.STENCIL_TEST))},setMask:function(de){ge!==de&&!O&&(r.stencilMask(de),ge=de)},setFunc:function(de,Qe,Oe){(re!==de||Ae!==Qe||ye!==Oe)&&(r.stencilFunc(de,Qe,Oe),re=de,Ae=Qe,ye=Oe)},setOp:function(de,Qe,Oe){(ue!==de||me!==Qe||Se!==Oe)&&(r.stencilOp(de,Qe,Oe),ue=de,me=Qe,Se=Oe)},setLocked:function(de){O=de},setClear:function(de){qe!==de&&(r.clearStencil(de),qe=de)},reset:function(){O=!1,ge=null,re=null,Ae=null,ye=null,ue=null,me=null,Se=null,qe=null}}}let s=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap,u={},d={},h={},f=new WeakMap,m=[],_=null,p=!1,g=null,S=null,M=null,x=null,C=null,E=null,w=null,y=new Je(0,0,0),b=0,P=!1,A=null,I=null,z=null,H=null,D=null,F=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS),U=!1,Y=0,ee=r.getParameter(r.VERSION);ee.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(ee)[1]),U=Y>=1):ee.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(ee)[1]),U=Y>=2);let L=null,le={},Me=r.getParameter(r.SCISSOR_BOX),Ne=r.getParameter(r.VIEWPORT),ke=new Gt().fromArray(Me),Be=new Gt().fromArray(Ne);function K(O,ge,re,Ae){let ye=new Uint8Array(4),ue=r.createTexture();r.bindTexture(O,ue),r.texParameteri(O,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(O,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let me=0;me<re;me++)O===r.TEXTURE_3D||O===r.TEXTURE_2D_ARRAY?r.texImage3D(ge,0,r.RGBA,1,1,Ae,0,r.RGBA,r.UNSIGNED_BYTE,ye):r.texImage2D(ge+me,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ye);return ue}let he={};he[r.TEXTURE_2D]=K(r.TEXTURE_2D,r.TEXTURE_2D,1),he[r.TEXTURE_CUBE_MAP]=K(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),he[r.TEXTURE_2D_ARRAY]=K(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),he[r.TEXTURE_3D]=K(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),fe(r.DEPTH_TEST),a.setFunc(Ps),B(!1),pe(If),fe(r.CULL_FACE),ce(nr);function fe(O){u[O]!==!0&&(r.enable(O),u[O]=!0)}function ve(O){u[O]!==!1&&(r.disable(O),u[O]=!1)}function Ve(O,ge){return h[O]!==ge?(r.bindFramebuffer(O,ge),h[O]=ge,O===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=ge),O===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=ge),!0):!1}function De(O,ge){let re=m,Ae=!1;if(O){re=f.get(ge),re===void 0&&(re=[],f.set(ge,re));let ye=O.textures;if(re.length!==ye.length||re[0]!==r.COLOR_ATTACHMENT0){for(let ue=0,me=ye.length;ue<me;ue++)re[ue]=r.COLOR_ATTACHMENT0+ue;re.length=ye.length,Ae=!0}}else re[0]!==r.BACK&&(re[0]=r.BACK,Ae=!0);Ae&&r.drawBuffers(re)}function Ze(O){return _!==O?(r.useProgram(O),_=O,!0):!1}let be={[Jr]:r.FUNC_ADD,[Mm]:r.FUNC_SUBTRACT,[bm]:r.FUNC_REVERSE_SUBTRACT};be[Tm]=r.MIN,be[Em]=r.MAX;let j={[wm]:r.ZERO,[Am]:r.ONE,[Cm]:r.SRC_COLOR,[pc]:r.SRC_ALPHA,[Um]:r.SRC_ALPHA_SATURATE,[Dm]:r.DST_COLOR,[Pm]:r.DST_ALPHA,[Rm]:r.ONE_MINUS_SRC_COLOR,[mc]:r.ONE_MINUS_SRC_ALPHA,[Lm]:r.ONE_MINUS_DST_COLOR,[Im]:r.ONE_MINUS_DST_ALPHA,[Nm]:r.CONSTANT_COLOR,[Fm]:r.ONE_MINUS_CONSTANT_COLOR,[Om]:r.CONSTANT_ALPHA,[Bm]:r.ONE_MINUS_CONSTANT_ALPHA};function ce(O,ge,re,Ae,ye,ue,me,Se,qe,de){if(O===nr){p===!0&&(ve(r.BLEND),p=!1);return}if(p===!1&&(fe(r.BLEND),p=!0),O!==Sm){if(O!==g||de!==P){if((S!==Jr||C!==Jr)&&(r.blendEquation(r.FUNC_ADD),S=Jr,C=Jr),de)switch(O){case Rs:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Df:r.blendFunc(r.ONE,r.ONE);break;case Lf:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Uf:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:nt("WebGLState: Invalid blending: ",O);break}else switch(O){case Rs:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Df:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Lf:nt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Uf:nt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:nt("WebGLState: Invalid blending: ",O);break}M=null,x=null,E=null,w=null,y.set(0,0,0),b=0,g=O,P=de}return}ye=ye||ge,ue=ue||re,me=me||Ae,(ge!==S||ye!==C)&&(r.blendEquationSeparate(be[ge],be[ye]),S=ge,C=ye),(re!==M||Ae!==x||ue!==E||me!==w)&&(r.blendFuncSeparate(j[re],j[Ae],j[ue],j[me]),M=re,x=Ae,E=ue,w=me),(Se.equals(y)===!1||qe!==b)&&(r.blendColor(Se.r,Se.g,Se.b,qe),y.copy(Se),b=qe),g=O,P=!1}function se(O,ge){O.side===Bt?ve(r.CULL_FACE):fe(r.CULL_FACE);let re=O.side===Yn;ge&&(re=!re),B(re),O.blending===Rs&&O.transparent===!1?ce(nr):ce(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),a.setFunc(O.depthFunc),a.setTest(O.depthTest),a.setMask(O.depthWrite),s.setMask(O.colorWrite);let Ae=O.stencilWrite;o.setTest(Ae),Ae&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),N(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?fe(r.SAMPLE_ALPHA_TO_COVERAGE):ve(r.SAMPLE_ALPHA_TO_COVERAGE)}function B(O){A!==O&&(O?r.frontFace(r.CW):r.frontFace(r.CCW),A=O)}function pe(O){O!==xm?(fe(r.CULL_FACE),O!==I&&(O===If?r.cullFace(r.BACK):O===vm?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):ve(r.CULL_FACE),I=O}function Ge(O){O!==z&&(U&&r.lineWidth(O),z=O)}function N(O,ge,re){O?(fe(r.POLYGON_OFFSET_FILL),(H!==ge||D!==re)&&(H=ge,D=re,a.getReversed()&&(ge=-ge),r.polygonOffset(ge,re))):ve(r.POLYGON_OFFSET_FILL)}function $(O){O?fe(r.SCISSOR_TEST):ve(r.SCISSOR_TEST)}function ie(O){O===void 0&&(O=r.TEXTURE0+F-1),L!==O&&(r.activeTexture(O),L=O)}function Re(O,ge,re){re===void 0&&(L===null?re=r.TEXTURE0+F-1:re=L);let Ae=le[re];Ae===void 0&&(Ae={type:void 0,texture:void 0},le[re]=Ae),(Ae.type!==O||Ae.texture!==ge)&&(L!==re&&(r.activeTexture(re),L=re),r.bindTexture(O,ge||he[O]),Ae.type=O,Ae.texture=ge)}function ae(){let O=le[L];O!==void 0&&O.type!==void 0&&(r.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function We(){try{r.compressedTexImage2D(...arguments)}catch(O){nt("WebGLState:",O)}}function R(){try{r.compressedTexImage3D(...arguments)}catch(O){nt("WebGLState:",O)}}function v(){try{r.texSubImage2D(...arguments)}catch(O){nt("WebGLState:",O)}}function V(){try{r.texSubImage3D(...arguments)}catch(O){nt("WebGLState:",O)}}function Q(){try{r.compressedTexSubImage2D(...arguments)}catch(O){nt("WebGLState:",O)}}function ne(){try{r.compressedTexSubImage3D(...arguments)}catch(O){nt("WebGLState:",O)}}function k(){try{r.texStorage2D(...arguments)}catch(O){nt("WebGLState:",O)}}function oe(){try{r.texStorage3D(...arguments)}catch(O){nt("WebGLState:",O)}}function J(){try{r.texImage2D(...arguments)}catch(O){nt("WebGLState:",O)}}function te(){try{r.texImage3D(...arguments)}catch(O){nt("WebGLState:",O)}}function we(O){return d[O]!==void 0?d[O]:r.getParameter(O)}function Ce(O,ge){d[O]!==ge&&(r.pixelStorei(O,ge),d[O]=ge)}function _e(O){ke.equals(O)===!1&&(r.scissor(O.x,O.y,O.z,O.w),ke.copy(O))}function xe(O){Be.equals(O)===!1&&(r.viewport(O.x,O.y,O.z,O.w),Be.copy(O))}function Te(O,ge){let re=c.get(ge);re===void 0&&(re=new WeakMap,c.set(ge,re));let Ae=re.get(O);Ae===void 0&&(Ae=r.getUniformBlockIndex(ge,O.name),re.set(O,Ae))}function je(O,ge){let Ae=c.get(ge).get(O);l.get(ge)!==Ae&&(r.uniformBlockBinding(ge,Ae,O.__bindingPointIndex),l.set(ge,Ae))}function it(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),r.pixelStorei(r.PACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!1),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,r.BROWSER_DEFAULT_WEBGL),r.pixelStorei(r.PACK_ROW_LENGTH,0),r.pixelStorei(r.PACK_SKIP_PIXELS,0),r.pixelStorei(r.PACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_ROW_LENGTH,0),r.pixelStorei(r.UNPACK_IMAGE_HEIGHT,0),r.pixelStorei(r.UNPACK_SKIP_PIXELS,0),r.pixelStorei(r.UNPACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_SKIP_IMAGES,0),u={},d={},L=null,le={},h={},f=new WeakMap,m=[],_=null,p=!1,g=null,S=null,M=null,x=null,C=null,E=null,w=null,y=new Je(0,0,0),b=0,P=!1,A=null,I=null,z=null,H=null,D=null,ke.set(0,0,r.canvas.width,r.canvas.height),Be.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:fe,disable:ve,bindFramebuffer:Ve,drawBuffers:De,useProgram:Ze,setBlending:ce,setMaterial:se,setFlipSided:B,setCullFace:pe,setLineWidth:Ge,setPolygonOffset:N,setScissorTest:$,activeTexture:ie,bindTexture:Re,unbindTexture:ae,compressedTexImage2D:We,compressedTexImage3D:R,texImage2D:J,texImage3D:te,pixelStorei:Ce,getParameter:we,updateUBOMapping:Te,uniformBlockBinding:je,texStorage2D:k,texStorage3D:oe,texSubImage2D:v,texSubImage3D:V,compressedTexSubImage2D:Q,compressedTexSubImage3D:ne,scissor:_e,viewport:xe,reset:it}}function n1(r,e,t,n,i,s,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ee,u=new WeakMap,d=new Set,h,f=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(R,v){return m?new OffscreenCanvas(R,v):Ca("canvas")}function p(R,v,V){let Q=1,ne=We(R);if((ne.width>V||ne.height>V)&&(Q=V/Math.max(ne.width,ne.height)),Q<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){let k=Math.floor(Q*ne.width),oe=Math.floor(Q*ne.height);h===void 0&&(h=_(k,oe));let J=v?_(k,oe):h;return J.width=k,J.height=oe,J.getContext("2d").drawImage(R,0,0,k,oe),tt("WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+k+"x"+oe+")."),J}else return"data"in R&&tt("WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),R;return R}function g(R){return R.generateMipmaps}function S(R){r.generateMipmap(R)}function M(R){return R.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?r.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function x(R,v,V,Q,ne,k=!1){if(R!==null){if(r[R]!==void 0)return r[R];tt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let oe;Q&&(oe=e.get("EXT_texture_norm16"),oe||tt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let J=v;if(v===r.RED&&(V===r.FLOAT&&(J=r.R32F),V===r.HALF_FLOAT&&(J=r.R16F),V===r.UNSIGNED_BYTE&&(J=r.R8),V===r.UNSIGNED_SHORT&&oe&&(J=oe.R16_EXT),V===r.SHORT&&oe&&(J=oe.R16_SNORM_EXT)),v===r.RED_INTEGER&&(V===r.UNSIGNED_BYTE&&(J=r.R8UI),V===r.UNSIGNED_SHORT&&(J=r.R16UI),V===r.UNSIGNED_INT&&(J=r.R32UI),V===r.BYTE&&(J=r.R8I),V===r.SHORT&&(J=r.R16I),V===r.INT&&(J=r.R32I)),v===r.RG&&(V===r.FLOAT&&(J=r.RG32F),V===r.HALF_FLOAT&&(J=r.RG16F),V===r.UNSIGNED_BYTE&&(J=r.RG8),V===r.UNSIGNED_SHORT&&oe&&(J=oe.RG16_EXT),V===r.SHORT&&oe&&(J=oe.RG16_SNORM_EXT)),v===r.RG_INTEGER&&(V===r.UNSIGNED_BYTE&&(J=r.RG8UI),V===r.UNSIGNED_SHORT&&(J=r.RG16UI),V===r.UNSIGNED_INT&&(J=r.RG32UI),V===r.BYTE&&(J=r.RG8I),V===r.SHORT&&(J=r.RG16I),V===r.INT&&(J=r.RG32I)),v===r.RGB_INTEGER&&(V===r.UNSIGNED_BYTE&&(J=r.RGB8UI),V===r.UNSIGNED_SHORT&&(J=r.RGB16UI),V===r.UNSIGNED_INT&&(J=r.RGB32UI),V===r.BYTE&&(J=r.RGB8I),V===r.SHORT&&(J=r.RGB16I),V===r.INT&&(J=r.RGB32I)),v===r.RGBA_INTEGER&&(V===r.UNSIGNED_BYTE&&(J=r.RGBA8UI),V===r.UNSIGNED_SHORT&&(J=r.RGBA16UI),V===r.UNSIGNED_INT&&(J=r.RGBA32UI),V===r.BYTE&&(J=r.RGBA8I),V===r.SHORT&&(J=r.RGBA16I),V===r.INT&&(J=r.RGBA32I)),v===r.RGB&&(V===r.UNSIGNED_SHORT&&oe&&(J=oe.RGB16_EXT),V===r.SHORT&&oe&&(J=oe.RGB16_SNORM_EXT),V===r.UNSIGNED_INT_5_9_9_9_REV&&(J=r.RGB9_E5),V===r.UNSIGNED_INT_10F_11F_11F_REV&&(J=r.R11F_G11F_B10F)),v===r.RGBA){let te=k?Po:mt.getTransfer(ne);V===r.FLOAT&&(J=r.RGBA32F),V===r.HALF_FLOAT&&(J=r.RGBA16F),V===r.UNSIGNED_BYTE&&(J=te===Mt?r.SRGB8_ALPHA8:r.RGBA8),V===r.UNSIGNED_SHORT&&oe&&(J=oe.RGBA16_EXT),V===r.SHORT&&oe&&(J=oe.RGBA16_SNORM_EXT),V===r.UNSIGNED_SHORT_4_4_4_4&&(J=r.RGBA4),V===r.UNSIGNED_SHORT_5_5_5_1&&(J=r.RGB5_A1)}return(J===r.R16F||J===r.R32F||J===r.RG16F||J===r.RG32F||J===r.RGBA16F||J===r.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function C(R,v){let V;return R?v===null||v===Hi||v===Va?V=r.DEPTH24_STENCIL8:v===Gi?V=r.DEPTH32F_STENCIL8:v===za&&(V=r.DEPTH24_STENCIL8,tt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Hi||v===Va?V=r.DEPTH_COMPONENT24:v===Gi?V=r.DEPTH_COMPONENT32F:v===za&&(V=r.DEPTH_COMPONENT16),V}function E(R,v){return g(R)===!0||R.isFramebufferTexture&&R.minFilter!==Mn&&R.minFilter!==Ot?Math.log2(Math.max(v.width,v.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?v.mipmaps.length:1}function w(R){let v=R.target;v.removeEventListener("dispose",w),b(v),v.isVideoTexture&&u.delete(v),v.isHTMLTexture&&d.delete(v)}function y(R){let v=R.target;v.removeEventListener("dispose",y),A(v)}function b(R){let v=n.get(R);if(v.__webglInit===void 0)return;let V=R.source,Q=f.get(V);if(Q){let ne=Q[v.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&P(R),Object.keys(Q).length===0&&f.delete(V)}n.remove(R)}function P(R){let v=n.get(R);r.deleteTexture(v.__webglTexture);let V=R.source,Q=f.get(V);delete Q[v.__cacheKey],a.memory.textures--}function A(R){let v=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(v.__webglFramebuffer[Q]))for(let ne=0;ne<v.__webglFramebuffer[Q].length;ne++)r.deleteFramebuffer(v.__webglFramebuffer[Q][ne]);else r.deleteFramebuffer(v.__webglFramebuffer[Q]);v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer[Q])}else{if(Array.isArray(v.__webglFramebuffer))for(let Q=0;Q<v.__webglFramebuffer.length;Q++)r.deleteFramebuffer(v.__webglFramebuffer[Q]);else r.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&r.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Q=0;Q<v.__webglColorRenderbuffer.length;Q++)v.__webglColorRenderbuffer[Q]&&r.deleteRenderbuffer(v.__webglColorRenderbuffer[Q]);v.__webglDepthRenderbuffer&&r.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let V=R.textures;for(let Q=0,ne=V.length;Q<ne;Q++){let k=n.get(V[Q]);k.__webglTexture&&(r.deleteTexture(k.__webglTexture),a.memory.textures--),n.remove(V[Q])}n.remove(R)}let I=0;function z(){I=0}function H(){return I}function D(R){I=R}function F(){let R=I;return R>=i.maxTextures&&tt("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+i.maxTextures),I+=1,R}function U(R){let v=[];return v.push(R.wrapS),v.push(R.wrapT),v.push(R.wrapR||0),v.push(R.magFilter),v.push(R.minFilter),v.push(R.anisotropy),v.push(R.internalFormat),v.push(R.format),v.push(R.type),v.push(R.generateMipmaps),v.push(R.premultiplyAlpha),v.push(R.flipY),v.push(R.unpackAlignment),v.push(R.colorSpace),v.join()}function Y(R,v){let V=n.get(R);if(R.isVideoTexture&&Re(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&V.__version!==R.version){let Q=R.image;if(Q===null)tt("WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)tt("WebGLRenderer: Texture marked for update but image is incomplete");else{ve(V,R,v);return}}else R.isExternalTexture&&(V.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,V.__webglTexture,r.TEXTURE0+v)}function ee(R,v){let V=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&V.__version!==R.version){ve(V,R,v);return}else R.isExternalTexture&&(V.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D_ARRAY,V.__webglTexture,r.TEXTURE0+v)}function L(R,v){let V=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&V.__version!==R.version){ve(V,R,v);return}t.bindTexture(r.TEXTURE_3D,V.__webglTexture,r.TEXTURE0+v)}function le(R,v){let V=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&V.__version!==R.version){Ve(V,R,v);return}t.bindTexture(r.TEXTURE_CUBE_MAP,V.__webglTexture,r.TEXTURE0+v)}let Me={[bc]:r.REPEAT,[Ki]:r.CLAMP_TO_EDGE,[Tc]:r.MIRRORED_REPEAT},Ne={[Mn]:r.NEAREST,[Vm]:r.NEAREST_MIPMAP_NEAREST,[Ko]:r.NEAREST_MIPMAP_LINEAR,[Ot]:r.LINEAR,[au]:r.LINEAR_MIPMAP_NEAREST,[ss]:r.LINEAR_MIPMAP_LINEAR},ke={[Wm]:r.NEVER,[Jm]:r.ALWAYS,[Xm]:r.LESS,[Wu]:r.LEQUAL,[qm]:r.EQUAL,[Xu]:r.GEQUAL,[Ym]:r.GREATER,[Zm]:r.NOTEQUAL};function Be(R,v){if(v.type===Gi&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Ot||v.magFilter===au||v.magFilter===Ko||v.magFilter===ss||v.minFilter===Ot||v.minFilter===au||v.minFilter===Ko||v.minFilter===ss)&&tt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(R,r.TEXTURE_WRAP_S,Me[v.wrapS]),r.texParameteri(R,r.TEXTURE_WRAP_T,Me[v.wrapT]),(R===r.TEXTURE_3D||R===r.TEXTURE_2D_ARRAY)&&r.texParameteri(R,r.TEXTURE_WRAP_R,Me[v.wrapR]),r.texParameteri(R,r.TEXTURE_MAG_FILTER,Ne[v.magFilter]),r.texParameteri(R,r.TEXTURE_MIN_FILTER,Ne[v.minFilter]),v.compareFunction&&(r.texParameteri(R,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(R,r.TEXTURE_COMPARE_FUNC,ke[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Mn||v.minFilter!==Ko&&v.minFilter!==ss||v.type===Gi&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){let V=e.get("EXT_texture_filter_anisotropic");r.texParameterf(R,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function K(R,v){let V=!1;R.__webglInit===void 0&&(R.__webglInit=!0,v.addEventListener("dispose",w));let Q=v.source,ne=f.get(Q);ne===void 0&&(ne={},f.set(Q,ne));let k=U(v);if(k!==R.__cacheKey){ne[k]===void 0&&(ne[k]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,V=!0),ne[k].usedTimes++;let oe=ne[R.__cacheKey];oe!==void 0&&(ne[R.__cacheKey].usedTimes--,oe.usedTimes===0&&P(v)),R.__cacheKey=k,R.__webglTexture=ne[k].texture}return V}function he(R,v,V){return Math.floor(Math.floor(R/V)/v)}function fe(R,v,V,Q){let k=R.updateRanges;if(k.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,v.width,v.height,V,Q,v.data);else{k.sort((Ce,_e)=>Ce.start-_e.start);let oe=0;for(let Ce=1;Ce<k.length;Ce++){let _e=k[oe],xe=k[Ce],Te=_e.start+_e.count,je=he(xe.start,v.width,4),it=he(_e.start,v.width,4);xe.start<=Te+1&&je===it&&he(xe.start+xe.count-1,v.width,4)===je?_e.count=Math.max(_e.count,xe.start+xe.count-_e.start):(++oe,k[oe]=xe)}k.length=oe+1;let J=t.getParameter(r.UNPACK_ROW_LENGTH),te=t.getParameter(r.UNPACK_SKIP_PIXELS),we=t.getParameter(r.UNPACK_SKIP_ROWS);t.pixelStorei(r.UNPACK_ROW_LENGTH,v.width);for(let Ce=0,_e=k.length;Ce<_e;Ce++){let xe=k[Ce],Te=Math.floor(xe.start/4),je=Math.ceil(xe.count/4),it=Te%v.width,O=Math.floor(Te/v.width),ge=je,re=1;t.pixelStorei(r.UNPACK_SKIP_PIXELS,it),t.pixelStorei(r.UNPACK_SKIP_ROWS,O),t.texSubImage2D(r.TEXTURE_2D,0,it,O,ge,re,V,Q,v.data)}R.clearUpdateRanges(),t.pixelStorei(r.UNPACK_ROW_LENGTH,J),t.pixelStorei(r.UNPACK_SKIP_PIXELS,te),t.pixelStorei(r.UNPACK_SKIP_ROWS,we)}}function ve(R,v,V){let Q=r.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Q=r.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Q=r.TEXTURE_3D);let ne=K(R,v),k=v.source;t.bindTexture(Q,R.__webglTexture,r.TEXTURE0+V);let oe=n.get(k);if(k.version!==oe.__version||ne===!0){if(t.activeTexture(r.TEXTURE0+V),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){let re=mt.getPrimaries(mt.workingColorSpace),Ae=v.colorSpace===Er?null:mt.getPrimaries(v.colorSpace),ye=v.colorSpace===Er||re===Ae?r.NONE:r.BROWSER_DEFAULT_WEBGL;t.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),t.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),t.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye)}t.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment);let te=p(v.image,!1,i.maxTextureSize);te=ae(v,te);let we=s.convert(v.format,v.colorSpace),Ce=s.convert(v.type),_e=x(v.internalFormat,we,Ce,v.normalized,v.colorSpace,v.isVideoTexture);Be(Q,v);let xe,Te=v.mipmaps,je=v.isVideoTexture!==!0,it=oe.__version===void 0||ne===!0,O=k.dataReady,ge=E(v,te);if(v.isDepthTexture)_e=C(v.format===as,v.type),it&&(je?t.texStorage2D(r.TEXTURE_2D,1,_e,te.width,te.height):t.texImage2D(r.TEXTURE_2D,0,_e,te.width,te.height,0,we,Ce,null));else if(v.isDataTexture)if(Te.length>0){je&&it&&t.texStorage2D(r.TEXTURE_2D,ge,_e,Te[0].width,Te[0].height);for(let re=0,Ae=Te.length;re<Ae;re++)xe=Te[re],je?O&&t.texSubImage2D(r.TEXTURE_2D,re,0,0,xe.width,xe.height,we,Ce,xe.data):t.texImage2D(r.TEXTURE_2D,re,_e,xe.width,xe.height,0,we,Ce,xe.data);v.generateMipmaps=!1}else je?(it&&t.texStorage2D(r.TEXTURE_2D,ge,_e,te.width,te.height),O&&fe(v,te,we,Ce)):t.texImage2D(r.TEXTURE_2D,0,_e,te.width,te.height,0,we,Ce,te.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){je&&it&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,_e,Te[0].width,Te[0].height,te.depth);for(let re=0,Ae=Te.length;re<Ae;re++)if(xe=Te[re],v.format!==Ri)if(we!==null)if(je){if(O)if(v.layerUpdates.size>0){let ye=id(xe.width,xe.height,v.format,v.type);for(let ue of v.layerUpdates){let me=xe.data.subarray(ue*ye/xe.data.BYTES_PER_ELEMENT,(ue+1)*ye/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,re,0,0,ue,xe.width,xe.height,1,we,me)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,re,0,0,0,xe.width,xe.height,te.depth,we,xe.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,re,_e,xe.width,xe.height,te.depth,0,xe.data,0,0);else tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else je?O&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,re,0,0,0,xe.width,xe.height,te.depth,we,Ce,xe.data):t.texImage3D(r.TEXTURE_2D_ARRAY,re,_e,xe.width,xe.height,te.depth,0,we,Ce,xe.data)}else{je&&it&&t.texStorage2D(r.TEXTURE_2D,ge,_e,Te[0].width,Te[0].height);for(let re=0,Ae=Te.length;re<Ae;re++)xe=Te[re],v.format!==Ri?we!==null?je?O&&t.compressedTexSubImage2D(r.TEXTURE_2D,re,0,0,xe.width,xe.height,we,xe.data):t.compressedTexImage2D(r.TEXTURE_2D,re,_e,xe.width,xe.height,0,xe.data):tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):je?O&&t.texSubImage2D(r.TEXTURE_2D,re,0,0,xe.width,xe.height,we,Ce,xe.data):t.texImage2D(r.TEXTURE_2D,re,_e,xe.width,xe.height,0,we,Ce,xe.data)}else if(v.isDataArrayTexture)if(je){if(it&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,_e,te.width,te.height,te.depth),O)if(v.layerUpdates.size>0){let re=id(te.width,te.height,v.format,v.type);for(let Ae of v.layerUpdates){let ye=te.data.subarray(Ae*re/te.data.BYTES_PER_ELEMENT,(Ae+1)*re/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Ae,te.width,te.height,1,we,Ce,ye)}v.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,we,Ce,te.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,_e,te.width,te.height,te.depth,0,we,Ce,te.data);else if(v.isData3DTexture)je?(it&&t.texStorage3D(r.TEXTURE_3D,ge,_e,te.width,te.height,te.depth),O&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,we,Ce,te.data)):t.texImage3D(r.TEXTURE_3D,0,_e,te.width,te.height,te.depth,0,we,Ce,te.data);else if(v.isFramebufferTexture){if(it)if(je)t.texStorage2D(r.TEXTURE_2D,ge,_e,te.width,te.height);else{let re=te.width,Ae=te.height;for(let ye=0;ye<ge;ye++)t.texImage2D(r.TEXTURE_2D,ye,_e,re,Ae,0,we,Ce,null),re>>=1,Ae>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in r){let re=r.canvas;if(re.hasAttribute("layoutsubtree")||re.setAttribute("layoutsubtree","true"),te.parentNode!==re){re.appendChild(te),d.add(v),re.onpaint=Se=>{let qe=Se.changedElements;for(let de of d)qe.includes(de.image)&&(de.needsUpdate=!0)},re.requestPaint();return}let Ae=0,ye=r.RGBA,ue=r.RGBA,me=r.UNSIGNED_BYTE;r.texElementImage2D(r.TEXTURE_2D,Ae,ye,ue,me,te),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.LINEAR),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE)}}else if(Te.length>0){if(je&&it){let re=We(Te[0]);t.texStorage2D(r.TEXTURE_2D,ge,_e,re.width,re.height)}for(let re=0,Ae=Te.length;re<Ae;re++)xe=Te[re],je?O&&t.texSubImage2D(r.TEXTURE_2D,re,0,0,we,Ce,xe):t.texImage2D(r.TEXTURE_2D,re,_e,we,Ce,xe);v.generateMipmaps=!1}else if(je){if(it){let re=We(te);t.texStorage2D(r.TEXTURE_2D,ge,_e,re.width,re.height)}O&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,we,Ce,te)}else t.texImage2D(r.TEXTURE_2D,0,_e,we,Ce,te);g(v)&&S(Q),oe.__version=k.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function Ve(R,v,V){if(v.image.length!==6)return;let Q=K(R,v),ne=v.source;t.bindTexture(r.TEXTURE_CUBE_MAP,R.__webglTexture,r.TEXTURE0+V);let k=n.get(ne);if(ne.version!==k.__version||Q===!0){t.activeTexture(r.TEXTURE0+V);let oe=mt.getPrimaries(mt.workingColorSpace),J=v.colorSpace===Er?null:mt.getPrimaries(v.colorSpace),te=v.colorSpace===Er||oe===J?r.NONE:r.BROWSER_DEFAULT_WEBGL;t.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),t.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),t.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),t.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,te);let we=v.isCompressedTexture||v.image[0].isCompressedTexture,Ce=v.image[0]&&v.image[0].isDataTexture,_e=[];for(let ue=0;ue<6;ue++)!we&&!Ce?_e[ue]=p(v.image[ue],!0,i.maxCubemapSize):_e[ue]=Ce?v.image[ue].image:v.image[ue],_e[ue]=ae(v,_e[ue]);let xe=_e[0],Te=s.convert(v.format,v.colorSpace),je=s.convert(v.type),it=x(v.internalFormat,Te,je,v.normalized,v.colorSpace),O=v.isVideoTexture!==!0,ge=k.__version===void 0||Q===!0,re=ne.dataReady,Ae=E(v,xe);Be(r.TEXTURE_CUBE_MAP,v);let ye;if(we){O&&ge&&t.texStorage2D(r.TEXTURE_CUBE_MAP,Ae,it,xe.width,xe.height);for(let ue=0;ue<6;ue++){ye=_e[ue].mipmaps;for(let me=0;me<ye.length;me++){let Se=ye[me];v.format!==Ri?Te!==null?O?re&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me,0,0,Se.width,Se.height,Te,Se.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me,it,Se.width,Se.height,0,Se.data):tt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me,0,0,Se.width,Se.height,Te,je,Se.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me,it,Se.width,Se.height,0,Te,je,Se.data)}}}else{if(ye=v.mipmaps,O&&ge){ye.length>0&&Ae++;let ue=We(_e[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,Ae,it,ue.width,ue.height)}for(let ue=0;ue<6;ue++)if(Ce){O?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,0,0,_e[ue].width,_e[ue].height,Te,je,_e[ue].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,it,_e[ue].width,_e[ue].height,0,Te,je,_e[ue].data);for(let me=0;me<ye.length;me++){let qe=ye[me].image[ue].image;O?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me+1,0,0,qe.width,qe.height,Te,je,qe.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me+1,it,qe.width,qe.height,0,Te,je,qe.data)}}else{O?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,0,0,Te,je,_e[ue]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,it,Te,je,_e[ue]);for(let me=0;me<ye.length;me++){let Se=ye[me];O?re&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me+1,0,0,Te,je,Se.image[ue]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me+1,it,Te,je,Se.image[ue])}}}g(v)&&S(r.TEXTURE_CUBE_MAP),k.__version=ne.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function De(R,v,V,Q,ne,k){let oe=s.convert(V.format,V.colorSpace),J=s.convert(V.type),te=x(V.internalFormat,oe,J,V.normalized,V.colorSpace),we=n.get(v),Ce=n.get(V);if(Ce.__renderTarget=v,!we.__hasExternalTextures){let _e=Math.max(1,v.width>>k),xe=Math.max(1,v.height>>k);ne===r.TEXTURE_3D||ne===r.TEXTURE_2D_ARRAY?t.texImage3D(ne,k,te,_e,xe,v.depth,0,oe,J,null):t.texImage2D(ne,k,te,_e,xe,0,oe,J,null)}t.bindFramebuffer(r.FRAMEBUFFER,R),ie(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Q,ne,Ce.__webglTexture,0,$(v)):(ne===r.TEXTURE_2D||ne>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Q,ne,Ce.__webglTexture,k),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Ze(R,v,V){if(r.bindRenderbuffer(r.RENDERBUFFER,R),v.depthBuffer){let Q=v.depthTexture,ne=Q&&Q.isDepthTexture?Q.type:null,k=C(v.stencilBuffer,ne),oe=v.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;ie(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,$(v),k,v.width,v.height):V?r.renderbufferStorageMultisample(r.RENDERBUFFER,$(v),k,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,k,v.width,v.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,oe,r.RENDERBUFFER,R)}else{let Q=v.textures;for(let ne=0;ne<Q.length;ne++){let k=Q[ne],oe=s.convert(k.format,k.colorSpace),J=s.convert(k.type),te=x(k.internalFormat,oe,J,k.normalized,k.colorSpace);ie(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,$(v),te,v.width,v.height):V?r.renderbufferStorageMultisample(r.RENDERBUFFER,$(v),te,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,te,v.width,v.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function be(R,v,V){let Q=v.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(r.FRAMEBUFFER,R),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let ne=n.get(v.depthTexture);if(ne.__renderTarget=v,(!ne.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Q){if(ne.__webglInit===void 0&&(ne.__webglInit=!0,v.depthTexture.addEventListener("dispose",w)),ne.__webglTexture===void 0){ne.__webglTexture=r.createTexture(),t.bindTexture(r.TEXTURE_CUBE_MAP,ne.__webglTexture),Be(r.TEXTURE_CUBE_MAP,v.depthTexture);let we=s.convert(v.depthTexture.format),Ce=s.convert(v.depthTexture.type),_e;v.depthTexture.format===Qi?_e=r.DEPTH_COMPONENT24:v.depthTexture.format===as&&(_e=r.DEPTH24_STENCIL8);for(let xe=0;xe<6;xe++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,_e,v.width,v.height,0,we,Ce,null)}}else Y(v.depthTexture,0);let k=ne.__webglTexture,oe=$(v),J=Q?r.TEXTURE_CUBE_MAP_POSITIVE_X+V:r.TEXTURE_2D,te=v.depthTexture.format===as?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(v.depthTexture.format===Qi)ie(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,te,J,k,0,oe):r.framebufferTexture2D(r.FRAMEBUFFER,te,J,k,0);else if(v.depthTexture.format===as)ie(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,te,J,k,0,oe):r.framebufferTexture2D(r.FRAMEBUFFER,te,J,k,0);else throw new Error("Unknown depthTexture format")}function j(R){let v=n.get(R),V=R.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==R.depthTexture){let Q=R.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Q){let ne=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Q.removeEventListener("dispose",ne)};Q.addEventListener("dispose",ne),v.__depthDisposeCallback=ne}v.__boundDepthTexture=Q}if(R.depthTexture&&!v.__autoAllocateDepthBuffer)if(V)for(let Q=0;Q<6;Q++)be(v.__webglFramebuffer[Q],R,Q);else{let Q=R.texture.mipmaps;Q&&Q.length>0?be(v.__webglFramebuffer[0],R,0):be(v.__webglFramebuffer,R,0)}else if(V){v.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[Q]),v.__webglDepthbuffer[Q]===void 0)v.__webglDepthbuffer[Q]=r.createRenderbuffer(),Ze(v.__webglDepthbuffer[Q],R,!1);else{let ne=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,k=v.__webglDepthbuffer[Q];r.bindRenderbuffer(r.RENDERBUFFER,k),r.framebufferRenderbuffer(r.FRAMEBUFFER,ne,r.RENDERBUFFER,k)}}else{let Q=R.texture.mipmaps;if(Q&&Q.length>0?t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=r.createRenderbuffer(),Ze(v.__webglDepthbuffer,R,!1);else{let ne=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,k=v.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,k),r.framebufferRenderbuffer(r.FRAMEBUFFER,ne,r.RENDERBUFFER,k)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function ce(R,v,V){let Q=n.get(R);v!==void 0&&De(Q.__webglFramebuffer,R,R.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),V!==void 0&&j(R)}function se(R){let v=R.texture,V=n.get(R),Q=n.get(v);R.addEventListener("dispose",y);let ne=R.textures,k=R.isWebGLCubeRenderTarget===!0,oe=ne.length>1;if(oe||(Q.__webglTexture===void 0&&(Q.__webglTexture=r.createTexture()),Q.__version=v.version,a.memory.textures++),k){V.__webglFramebuffer=[];for(let J=0;J<6;J++)if(v.mipmaps&&v.mipmaps.length>0){V.__webglFramebuffer[J]=[];for(let te=0;te<v.mipmaps.length;te++)V.__webglFramebuffer[J][te]=r.createFramebuffer()}else V.__webglFramebuffer[J]=r.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){V.__webglFramebuffer=[];for(let J=0;J<v.mipmaps.length;J++)V.__webglFramebuffer[J]=r.createFramebuffer()}else V.__webglFramebuffer=r.createFramebuffer();if(oe)for(let J=0,te=ne.length;J<te;J++){let we=n.get(ne[J]);we.__webglTexture===void 0&&(we.__webglTexture=r.createTexture(),a.memory.textures++)}if(R.samples>0&&ie(R)===!1){V.__webglMultisampledFramebuffer=r.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let J=0;J<ne.length;J++){let te=ne[J];V.__webglColorRenderbuffer[J]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,V.__webglColorRenderbuffer[J]);let we=s.convert(te.format,te.colorSpace),Ce=s.convert(te.type),_e=x(te.internalFormat,we,Ce,te.normalized,te.colorSpace,R.isXRRenderTarget===!0),xe=$(R);r.renderbufferStorageMultisample(r.RENDERBUFFER,xe,_e,R.width,R.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+J,r.RENDERBUFFER,V.__webglColorRenderbuffer[J])}r.bindRenderbuffer(r.RENDERBUFFER,null),R.depthBuffer&&(V.__webglDepthRenderbuffer=r.createRenderbuffer(),Ze(V.__webglDepthRenderbuffer,R,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(k){t.bindTexture(r.TEXTURE_CUBE_MAP,Q.__webglTexture),Be(r.TEXTURE_CUBE_MAP,v);for(let J=0;J<6;J++)if(v.mipmaps&&v.mipmaps.length>0)for(let te=0;te<v.mipmaps.length;te++)De(V.__webglFramebuffer[J][te],R,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+J,te);else De(V.__webglFramebuffer[J],R,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0);g(v)&&S(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let J=0,te=ne.length;J<te;J++){let we=ne[J],Ce=n.get(we),_e=r.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(_e=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(_e,Ce.__webglTexture),Be(_e,we),De(V.__webglFramebuffer,R,we,r.COLOR_ATTACHMENT0+J,_e,0),g(we)&&S(_e)}t.unbindTexture()}else{let J=r.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(J=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(J,Q.__webglTexture),Be(J,v),v.mipmaps&&v.mipmaps.length>0)for(let te=0;te<v.mipmaps.length;te++)De(V.__webglFramebuffer[te],R,v,r.COLOR_ATTACHMENT0,J,te);else De(V.__webglFramebuffer,R,v,r.COLOR_ATTACHMENT0,J,0);g(v)&&S(J),t.unbindTexture()}R.depthBuffer&&j(R)}function B(R){let v=R.textures;for(let V=0,Q=v.length;V<Q;V++){let ne=v[V];if(g(ne)){let k=M(R),oe=n.get(ne).__webglTexture;t.bindTexture(k,oe),S(k),t.unbindTexture()}}}let pe=[],Ge=[];function N(R){if(R.samples>0){if(ie(R)===!1){let v=R.textures,V=R.width,Q=R.height,ne=r.COLOR_BUFFER_BIT,k=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,oe=n.get(R),J=v.length>1;if(J)for(let we=0;we<v.length;we++)t.bindFramebuffer(r.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+we,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,oe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+we,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);let te=R.texture.mipmaps;te&&te.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let we=0;we<v.length;we++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(ne|=r.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(ne|=r.STENCIL_BUFFER_BIT)),J){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,oe.__webglColorRenderbuffer[we]);let Ce=n.get(v[we]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ce,0)}r.blitFramebuffer(0,0,V,Q,0,0,V,Q,ne,r.NEAREST),l===!0&&(pe.length=0,Ge.length=0,pe.push(r.COLOR_ATTACHMENT0+we),R.depthBuffer&&R.resolveDepthBuffer===!1&&(pe.push(k),Ge.push(k),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ge)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,pe))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),J)for(let we=0;we<v.length;we++){t.bindFramebuffer(r.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+we,r.RENDERBUFFER,oe.__webglColorRenderbuffer[we]);let Ce=n.get(v[we]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,oe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+we,r.TEXTURE_2D,Ce,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){let v=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[v])}}}function $(R){return Math.min(i.maxSamples,R.samples)}function ie(R){let v=n.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Re(R){let v=a.render.frame;u.get(R)!==v&&(u.set(R,v),R.update())}function ae(R,v){let V=R.colorSpace,Q=R.format,ne=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||V!==Ro&&V!==Er&&(mt.getTransfer(V)===Mt?(Q!==Ri||ne!==ii)&&tt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):nt("WebGLTextures: Unsupported texture color space:",V)),v}function We(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=z,this.getTextureUnits=H,this.setTextureUnits=D,this.setTexture2D=Y,this.setTexture2DArray=ee,this.setTexture3D=L,this.setTextureCube=le,this.rebindTextures=ce,this.setupRenderTarget=se,this.updateRenderTargetMipmap=B,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=j,this.setupFrameBufferTexture=De,this.useMultisampledRTT=ie,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function i1(r,e){function t(n,i=Er){let s,a=mt.getTransfer(i);if(n===ii)return r.UNSIGNED_BYTE;if(n===lu)return r.UNSIGNED_SHORT_4_4_4_4;if(n===cu)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Xf)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===qf)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===Gf)return r.BYTE;if(n===Wf)return r.SHORT;if(n===za)return r.UNSIGNED_SHORT;if(n===ou)return r.INT;if(n===Hi)return r.UNSIGNED_INT;if(n===Gi)return r.FLOAT;if(n===gi)return r.HALF_FLOAT;if(n===Yf)return r.ALPHA;if(n===Zf)return r.RGB;if(n===Ri)return r.RGBA;if(n===Qi)return r.DEPTH_COMPONENT;if(n===as)return r.DEPTH_STENCIL;if(n===Jf)return r.RED;if(n===uu)return r.RED_INTEGER;if(n===os)return r.RG;if(n===hu)return r.RG_INTEGER;if(n===fu)return r.RGBA_INTEGER;if(n===Qo||n===jo||n===el||n===tl)if(a===Mt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Qo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===jo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Qo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===jo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===el)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===tl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===du||n===pu||n===mu||n===gu)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===du)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===pu)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===mu)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===gu)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===_u||n===xu||n===vu||n===yu||n===Su||n===nl||n===Mu)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===_u||n===xu)return a===Mt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===vu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===yu)return s.COMPRESSED_R11_EAC;if(n===Su)return s.COMPRESSED_SIGNED_R11_EAC;if(n===nl)return s.COMPRESSED_RG11_EAC;if(n===Mu)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===bu||n===Tu||n===Eu||n===wu||n===Au||n===Cu||n===Ru||n===Pu||n===Iu||n===Du||n===Lu||n===Uu||n===Nu||n===Fu)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===bu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Tu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Eu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===wu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Au)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Cu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ru)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Pu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Iu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Du)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Lu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Uu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Nu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Fu)return a===Mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ou||n===Bu||n===ku)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Ou)return a===Mt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Bu)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ku)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===zu||n===Vu||n===il||n===Hu)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===zu)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Vu)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===il)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Hu)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Va?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}var r1=`
void main() {
...
`+c.fragmentShader,c.fragmentShader=c.fragmentShader.replace("#include <color_fragment>",`
      ...
      `)},l.customProgramCacheKey=()=>"diana-opaque-jewel-v1",l});return{materials:i,update(s,a){r.material=s>0?i:e,t.value=a,i.forEach((o,l)=>{o.envMapRotation.set(.06*Math.sin(a*.19),.22*Math.sin(a*.23+l*.7),0)})}}}var fr=Or;function q_(r,e,t){let{smoothstep:n,lerp:i,clamp:s}=rt,a=e-t,o=t===0&&e<=0?r:n(1+a,.32,1),l=s(a,0,1),c=n(o,.12,1),u=n(l,0,.9),d=-.92*(1-c+u);return{angle:d,yaw:d*.48,y:-.3*(1-c)+u*.65,opacity:n(o,0,.35)*(1-n(l,.32,.9)),curvature:64}}function Y_(r){return r*.18}var zl=rt.smoothstep,Ss=r=>{let e=Math.sin(r*127.1+311.7)*43758.5453;return e-Math.floor(e)};function vE(r,e,t){let n=Ss(e+9)*.05,i=zl(r,.08+n,.82),s=Math.atan2(t.y,t.x),a=Math.pow(i,1.35)*(4.6+Ss(e+20)*3.8);return{x:Math.cos(s)*a,y:Math.sin(s)*a-i*i*1.3,z:i*(2+Ss(e+40)*6),rx:i*(Ss(e+50)-.5)*3,ry:i*(Ss(e+60)-.5)*4,rz:i*(Ss(e+70)-.5)*2,opacity:1-zl(i,.5,.95),edge:zl(r,.035,.18)*(1-zl(i,.42,.88))}}function yE(r){let t=[.17,.49,1.02,Math.hypot(r,1)+.8],n=new Ee(r*.06,.025),i=t.map((a,o)=>Array.from({length:17},(l,c)=>{let u=c/17*Math.PI*2+(Ss(c+1)-.5)*.11,d=a*(o===3?1:.84+Ss(o*17+c+99)*.32);return new Ee(Math.cos(u)*d,Math.sin(u)*d).add(n)})),s=[];for(let a=0;a<17;a++){let o=(a+1)%17;s.push([n,i[0][a],i[0][o]]);for(let l=0;l<i.length-1;l++){let c=i[l][a],u=i[l][o],d=i[l+1][a],h=i[l+1][o];s.push([c,d,h],[c,h,u])}}return s}function Z_(r,e){let t=new qn;t.background=new Je("#f1f3f0");let n=new ns(-1,1,1,-1,.1,40);n.position.z=12;let i=new gt(new ln(2,2),new on({map:e,transparent:!0,opacity:0,toneMapped:!1,depthWrite:!1}));i.position.z=-8,i.renderOrder=-1,t.add(i);let s=[];return{resize(a,o){let l=a/o;n.left=-l,n.right=l,n.updateProjectionMatrix(),i.scale.x=l;let c=e.image.width/e.image.height,u=Math.min(1,l/c),d=Math.min(1,c/l);e.repeat.set(u,d),e.offset.set((1-u)*(o>a?.1:.5),(1-d)/2),e.needsUpdate=!0,s.forEach(h=>h.group.traverse(f=>{f.geometry?.dispose(),f.material?.dispose()})),t.clear(),t.add(i),s=yE(l).map((h,f)=>{let m=h.reduce((y,b)=>y.add(b),new Ee).multiplyScalar(.3333333333333333),_=h.map(y=>new G(y.x-m.x,y.y-m.y,0)),p=new an().setFromPoints(_);p.setAttribute("uv",new Sn(h.flatMap(y=>[y.x/(l*2)+.5,y.y/2+.5]),2)),p.computeVertexNormals();let g=new on({map:r,side:Bt,transparent:!0,toneMapped:!1}),S=new gt(p,g),M=new Nn;M.add(S),M.position.set(m.x,m.y,0);let x=new Ds(new an().setFromPoints(_.map(y=>y.clone().setZ(.004))),new Kr({color:"#dff7ff",transparent:!0,opacity:0}));M.add(x);let C=[];for(let y=0;y<3;y++){let b=_[y],P=_[(y+1)%3];C.push(b.x,b.y,0,P.x,P.y,0,P.x,P.y,-.024,b.x,b.y,0,P.x,P.y,-.024,b.x,b.y,-.024)}let E=new an;E.setAttribute("position",new Sn(C,3));let w=new gt(E,new on({color:"#81b5c7",side:Bt,transparent:!0,opacity:0,toneMapped:!1}));return M.add(w),t.add(M),{group:M,material:g,edge:x,side:w,center:m,index:f}})},render(a,o){i.material.opacity=zl(o,.24,.55);for(let l of s){let c=vE(o,l.index,l.center);l.group.position.set(l.center.x+c.x,l.center.y+c.y,c.z),l.group.rotation.set(c.rx,c.ry,c.rz),l.group.visible=c.opacity>.001,l.material.opacity=c.opacity,l.edge.material.opacity=c.edge*.62,l.side.material.opacity=c.edge*.75}a.render(t,n)}}}var go=rt.smoothstep,mo=rt.lerp;function J_(r){return{approach:go(r,0,.56),distortion:go(r,.34,.56)*(1-go(r,.74,1)),reveal:go(r,.6,.96)}}async function $_(r,e){let t=new qn;t.background=new Je("#090b15"),t.environment=e;let n=new yn(38,1,.1,80);n.position.set(0,.1,11),n.lookAt(0,0,-2);let i=new qn,s=new Tr,a=new bn(1,1,{type:gi}),o=new bn(1,1,{type:gi}),l=await new ts().loadAsync(Pn("day-student.webp"));l.colorSpace=Vt;let c=Z_(o.texture,l);a.samples=4,o.samples=4;let u={uOriginal:{value:a.texture},uRoom:{value:o.texture},uReveal:{value:0},uDistort:{value:0},uProgress:{value:0}},d=new en({uniforms:u,depthTest:!1,depthWrite:!1,toneMapped:!1,vertexShader:"varying vec2 vUv; void main(){vUv=uv;gl_Position=vec4(position.xy,0.,1.);}",fragmentShader:`
    ...
    `});i.add(new gt(new ln(2,2),d));let h={uTime:{value:0},uTravel:{value:0},uPaletteSpread:{value:1}},f=new ln(46,30,192,8),m=f.attributes.position,_=m.array.slice();f.setAttribute("gridCoord",new sn(_,3));for(let A=0;A<m.count;A++){let I=m.getX(A)/15;m.setXYZ(A,15*Math.sin(I),m.getY(A),15*(1-Math.cos(I)))}f.computeVertexNormals(),f.computeBoundingSphere();let p=new gt(f,new en({uniforms:h,side:Bt,toneMapped:!1,depthWrite:!1,vertexShader:`attribute vec3 gridCoord; varying vec2 vGrid;
    ...
    `}));p.position.set(0,0,-7),p.rotation.set(.03,-.25,-.065),p.renderOrder=-1,t.add(p);let g=await Promise.all(fr.map(async A=>{let I=await new ts().loadAsync(A.image);I.colorSpace=Vt,I.anisotropy=Math.min(8,r.capabilities.getMaxAnisotropy());let z=new gt(kl(6,3.375),new on({map:I,side:Bt,transparent:!0,opacity:0,toneMapped:!1}));z.position.z=.016;let H=new Nn;H.add(z),t.add(H);let D=po(6,3.375);H.add(D.group);let F=null,U=null;return A.video&&!A.videoPending&&(F=document.createElement("video"),F.muted=!0,F.loop=!1,F.playsInline=!0,F.preload="metadata",F.src=A.video,U=new Fo(F),U.colorSpace=Vt,F.addEventListener("loadeddata",()=>{z.material.map=U,z.material.needsUpdate=!0}),F.addEventListener("error",()=>{z.material.map=I,z.material.needsUpdate=!0})),{group:H,image:z,frame:D,texture:I,video:F,playing:!1,started:!1,finished:!1,lastProgressAt:0,lastTime:0}})),S=new is("#e5f6ff",2);S.position.set(3,4,7),t.add(S);let M=-2,x=0,C=9,E=!1,w=()=>{},y=()=>{};function b(A,I){A.video?.pause(),A.playing=!1,A.finished=!0,y(I)}g.forEach((A,I)=>{A.video?.addEventListener("ended",()=>b(A,I)),A.video?.addEventListener("error",()=>b(A,I))});function P(A,I){A.playing=!0,A.lastProgressAt=performance.now(),A.video.play().catch(()=>b(A,I))}return{setVideoCallbacks({onStart:A,onEnd:I}){w=A??w,y=I??y},videoState(){return g.map(A=>({started:A.started,finished:A.finished,playing:A.playing,duration:A.video?.duration??0,currentTime:A.video?.currentTime??0,paused:A.video?.paused??!0,angle:A.group.rotation.y,opacity:A.image.material.opacity}))},setPlayback(A){E=A,g.forEach((I,z)=>{!I.started||I.finished||(A?I.playing||P(I,z):(I.video.pause(),I.playing=!1))})},cancelPlayback(){g.forEach((A,I)=>{A.started&&!A.finished&&b(A,I)})},prepare(A,I,z){let H=J_(z.dive);if(H.approach>0){I.updateWorldMatrix(!0,!1);let D=new G(.6,-.45,.35).applyMatrix4(I.matrixWorld),F=new G(0,.12,10.8),U=D.clone().add(new G(0,0,.7));A.position.copy(F.lerp(U,H.approach)),A.lookAt(new G().lerp(D,H.approach))}return H},resize(A,I,z){for(let U of[a,o])U.setSize(Math.round(A*z),Math.round(I*z));c.resize(A,I),n.aspect=A/I,n.updateProjectionMatrix();let H=2*Math.tan(19*Math.PI/180)*11,D=H*A/I,F=A<1e3&&I>A;h.uPaletteSpread.value=F?1.8:1,M=F?0:-D*.18,x=F?H*.08:0,C=D*1.25;for(let U of g){let Y=U.texture.image.width/U.texture.image.height,ee=H*(F?.33:.52),L=Math.min(F?D*.86:D*.52,ee*Y),le=L/Y;U.image.geometry.dispose(),U.image.geometry=kl(L,le),U.group.remove(U.frame.group),U.frame.dispose(),U.frame=po(L,le),U.group.add(U.frame.group)}},render(A,I,z,H){if(z.dive<=0){I();return}let D=J_(z.dive),F=go(z.dive,.6,1),U=go(z.breach||0,0,.48);n.position.set(mo(-1.1,0,F)+U*.5,.1,mo(mo(8.8,11,F),-3.5,U)),n.lookAt(mo(1,0,F),0,mo(-2,-7,U)),n.rotateZ(mo(-.08,0,F));for(let[le,Me]of g.entries()){let Ne=q_(z.day,z.dayIndex||0,le);Me.group.visible=Ne.opacity>.001&&!z.breach,Me.group.position.set(M+Math.sin(Ne.angle)*C,x+Ne.y,C*(Math.cos(Ne.angle)-1)),Me.group.rotation.set(0,Ne.yaw,0),Me.image.material.opacity=Ne.opacity,Me.group.visible&&zh(Me.image.geometry,Ne.curvature),Me.frame.update(Ne.opacity,Ne.curvature)}let Y=g[z.dayActive],ee=z.day>=.999&&Math.abs(z.dayIndex-z.dayActive)<1e-4&&z.dayCopy>.999&&Y?.group.visible&&Math.abs(Y.group.rotation.y)<1e-4;E&&ee&&Y?.video&&!Y.started&&!Y.finished&&(Y.started=!0,Y.video.currentTime=0,w(z.dayActive,z.timelinePixels),P(Y,z.dayActive)),g.forEach((le,Me)=>{!le.playing||!le.video||(le.video.currentTime>le.lastTime?(le.lastTime=le.video.currentTime,le.lastProgressAt=performance.now()):performance.now()-le.lastProgressAt>15e3&&b(le,Me))}),h.uTime.value=H,h.uTravel.value=Y_(H),u.uReveal.value=D.reveal,u.uDistort.value=D.distortion,u.uProgress.value=z.dive;let L=A.getRenderTarget();D.reveal<1&&(A.setRenderTarget(a),I()),A.setRenderTarget(o),A.render(t,n),A.setRenderTarget(L),z.breach>.2?c.render(A,z.breach):A.render(i,s)}}}function K_(){let r=new Set,e=null;return{get active(){return e},cancel(){e&&r.add(e.id),e=null},update(t,n,i,s){if(e){if(i-e.startedAt<e.duration)return e.point;r.add(e.id),e=null}if(n<t-2){for(let o of s)n<o.point-80&&r.delete(o.id);return n}let a=s.find(o=>!r.has(o.id)&&t<=o.point&&n>=o.point);return a?(e={...a,startedAt:i},a.point):n}}}function Q_(r,e=!1){let t=(s,a)=>{let o=Math.max(0,Math.min(1,(r-s)/(a-s)));return o*o*(3-2*o)},n=t(.05,.26),i=e?0:t(.78,.98);return{opacity:n*(1-i),y:18*(1-n)-18*i}}var Fi=document.querySelector("#scene"),Vl=document.querySelector(".hero"),j_=document.querySelector(".header"),Br=document.querySelector("#motion"),yt=matchMedia("(prefers-reduced-motion: reduce)"),Up=matchMedia("(hover: hover) and (pointer: fine)"),qi=document.querySelector(".hero-story"),sa=document.querySelector(".carousel-copy"),Np=document.querySelector(".carousel-controls"),ex=document.querySelector(".hero-footer"),Ms=document.querySelector(".tutor-intro"),aa=document.querySelector(".vision-copy"),oa=document.querySelector(".day-copy"),_o=oa.querySelector(".day-caption"),SE=oa.querySelector(".day-controls"),Ei=document.querySelector(".control-chapter"),ME=Ei.querySelector(".control-photo"),Fp=[...Ei.querySelectorAll(".control-beat")],Vh=[...sa.querySelectorAll("p")],Op=_o.querySelector(".day-summary"),Bp=_o.querySelector(".day-detail"),la=Ei.cloneNode(!0),kp=document.querySelector(".story-progress");la.removeAttribute("id");la.removeAttribute("aria-labelledby");la.removeAttribute("aria-hidden");la.inert=!1;la.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id"));document.querySelector(".fallback-control").append(la);document.querySelectorAll(".closing-emblem path").forEach(r=>r.setAttribute("pathLength","1"));var tx=[...aa.querySelectorAll(".outline-title path")],zp=[...aa.querySelectorAll(".vision-sequence > *")],Xe={ready:!1,playing:!yt.matches,renders:0,time:0,progress:0,rotation:0,rotating:!yt.matches,reducedMotion:yt.matches};window.__dianaComposition=Xe;mh.registerPlugin(ot);var Hh=(r,e={})=>window.dispatchEvent(new CustomEvent("diana:cinematic-event",{detail:{name:r,...e}}));document.querySelectorAll('a[href="#waitlist"]').forEach(r=>r.addEventListener("click",()=>Hh("cta",{location:r.classList.contains("header-cta")?"header":"hero"})));document.querySelectorAll(".chapter-menu a").forEach(r=>r.addEventListener("click",()=>{r.closest("details").open=!1}));var Yi=document.querySelector("#work-dialog");function nx(r){Yi.classList.remove("zoomed"),document.querySelector("#zoom-screen").setAttribute("aria-pressed","false"),Yi.querySelector("source").srcset=r.mobile||r.image,Yi.querySelector("img").src=r.image,Yi.querySelector("img").alt=r.alt,document.querySelector("#dialog-heading").textContent=r.title,Yi.showModal()}function Gh(r=0,e=!1){nx((e?fr:ni)[r])}document.querySelectorAll("[data-control]").forEach(r=>r.addEventListener("click",()=>{let e=r.closest(".control-beat"),t=e.querySelector("img");nx({title:e.querySelector("h3").textContent,image:t.getAttribute("src"),alt:t.alt})}));document.querySelectorAll("[data-slide]").forEach(r=>r.addEventListener("click",()=>Gh(Number(r.dataset.slide))));document.querySelectorAll("[data-day]").forEach(r=>r.addEventListener("click",()=>Gh(Number(r.dataset.day),!0)));document.querySelector("#zoom-screen").addEventListener("click",r=>{let e=Yi.classList.toggle("zoomed");r.currentTarget.setAttribute("aria-pressed",String(e))});document.querySelector("#close-dialog").addEventListener("click",()=>Yi.close());Yi.addEventListener("click",r=>{r.target===Yi&&Yi.close()});async function bE(){await Promise.all([document.fonts.load("600 100px Outfit"),document.fonts.load("700 200px Outfit")]);let r=new Ju({canvas:Fi,antialias:!0,powerPreference:"high-performance"});r.outputColorSpace=Vt,r.toneMapping=Jo,r.toneMappingExposure=1,r.transmissionResolutionScale=1;let e=new qn;e.background=new Je("#08090c");let t=new yn(32,1,.1,80);t.position.set(0,.12,10.8),t.lookAt(0,0,0);let n=D_(r);e.environment=n.texture;let i=await L_(),s=X_(i),a=W_(i),o=U_(),l=F_(),c=await z_(r),u=await $_(r,n.texture);l.uniforms.uBrand.value=o.material.map;let d=new Nt;e.add(l.mesh,i,c.group,a.backdrop);let h=new is("#ffffff",2);h.position.set(-3,5,6),e.add(h);let f=new is("#e0eaff",.45);f.position.set(4,-1,3),e.add(f);let m=new Ee,_=new Ee,p=0,g=0,S=!0,M,x,C=0,E=1,w=0,y=0,b=!1,P=-1,A=-1,I=-1,z=!1,H={progress:0},D={active:!1,complete:!1,departed:!1,startedAt:0,lockedY:0,duration:6200,progress:0},F={active:!1,index:-1,lockedY:0,lockedTimeline:0},U=K_(),Y=0,ee=0,L=[],le=new Set(["ArrowDown","ArrowUp","PageDown","PageUp","Home","End"," "]);function Me($,ie,Re){let ae=rt.clamp(($-ie)/(Re-ie),0,1);return ae*ae*(3-2*ae)}function Ne($){!D.active&&!F.active&&!U.active||$.type==="keydown"&&!le.has($.key)||$.preventDefault()}window.addEventListener("wheel",Ne,{passive:!1}),window.addEventListener("touchmove",Ne,{passive:!1}),window.addEventListener("keydown",Ne);function ke(){let $=F.active?F.lockedY:U.active?ee:null;$===null||Math.abs(scrollY-$)<=1||window.scrollTo({top:$,left:0,behavior:"instant"})}window.addEventListener("scroll",ke,{passive:!0}),u.setVideoCallbacks({onStart($,ie){!x||yt.matches||F.active||(F.active=!0,F.index=$,F.lockedY=j(ie),F.lockedTimeline=ie,H.progress=(F.lockedY-qi.offsetTop)/Math.max(1,M.scrollTrigger.end-M.scrollTrigger.start),ke())},onEnd($){F.index===$&&(F.active=!1,F.index=-1,F.lockedTimeline=0)}});function Be(){U.cancel(),u.cancelPlayback(),F.active=!1,D.active=!1}function K(){let $=Math.max(1,M?.scrollTrigger?.end-M?.scrollTrigger?.start||1),ie=rt.clamp((scrollY-qi.offsetTop)/$,0,1);b&&Math.abs(H.progress-ie)<.001&&(b=!1);let Re=yt.matches?0:b?ie:H.progress;Xe.progress=Re;let ae=Re*$,We=Math.max(0,scrollY-qi.offsetTop),R=Math.abs(ae-We)<innerHeight*.3,v=We<y-1?-1:We>y+1?1:0,V=Math.max(0,x.textExit-x.tutorLockStart);D.complete&&We>x.tutorLockStart+innerHeight*.5&&(D.departed=!0),D.complete&&D.departed&&v<0&&We<=x.tutorLockStart+innerHeight*.08&&(D.complete=!1,D.departed=!1,D.progress=0);let Q=D.complete?Math.max(x.textExit,ae+V):ae,ne=F.active?F.lockedTimeline:Q;if(Xe.playing&&!yt.matches&&!b&&!F.active){ne=U.update(Y,ne,performance.now(),x.readingStops);let Ie=u.videoState(),xt=x.dayPlaybackStops.find((et,pt)=>et!==null&&!Ie[pt].started&&!Ie[pt].finished&&Y<=et&&ne>=et);xt!==void 0&&(ne=xt),(U.active||xt!==void 0)&&(ee=j(ne),Math.abs(scrollY-ee)>1&&window.scrollTo({top:ee,left:0,behavior:"instant"}),H.progress=(ee-qi.offsetTop)/$,R=!0)}let k=x.at(ne),oe=0,J=14,te=.985;if(ae<x.tutorLockStart-48&&(D.complete=!1,D.active=!1,D.departed=!1,D.progress=0),!yt.matches&&!D.complete&&R&&(D.active||ae>=x.tutorLockStart&&ae<x.carouselStart)){D.active||(D.active=!0,D.startedAt=performance.now(),D.lockedY=qi.offsetTop+x.tutorLockStart),Math.abs(scrollY-D.lockedY)>1&&window.scrollTo({top:D.lockedY,left:0,behavior:"instant"});let Ie=rt.clamp((performance.now()-D.startedAt)/D.duration,0,1),xt=Me(Ie,.025,.43),et=Me(Ie,.74,.98),pt=Me(Ie,.74,1);D.progress=Ie,oe=xt*(1-et),J=rt.lerp(18,-70,pt),te=rt.lerp(.982,1,xt)-pt*.018,k={...k,opening:0,tutor:0,x:x.tutorX,y:x.tutorY,stage:0,copy:0},Ie>=1&&(D.active=!1,D.complete=!0,D.departed=!1,k=x.at(x.textExit))}else D.complete&&ae<x.textExit&&(k={...k,tutor:0,x:x.tutorX,y:x.tutorY});Ms&&(Ms.style.setProperty("--tutor-alpha",String(oe)),Ms.style.setProperty("--tutor-y",`${J}px`),Ms.style.setProperty("--tutor-scale",String(te)));let Ce=Math.round(Re*100);kp.style.setProperty("--story-progress",`${Ce}%`),kp.setAttribute("aria-valuenow",String(Ce));let _e=k.control>.4?"Your control":k.day>.2?"Your day":k.vision>.1?"Why Diana":k.stage>.2?"Diana workspace":"Introduction";kp.querySelector("b").textContent=_e,s.update(k.vision,Xe.time),a.update(k.vision,Xe.time),l.mesh.visible=Xe.layers?.wall!==!1&&k.vision===0,l.uniforms.uTime.value=Xe.time,l.uniforms.uOpening.value=k.opening,l.uniforms.uTutor.value=k.tutor,l.uniforms.uTutorOffset.value.set(k.x,k.y),l.uniforms.uBrandOpacity.value=o.visible?k.opening:0,l.uniforms.uIntensity.value=.55-k.stage*.25,c.update(k.stage,k.index,k.productDetail),Xe.finalizing=k.growth>0;let Te=Fi.clientWidth>=700&&Fi.clientWidth<1e3&&Fi.clientHeight>Fi.clientWidth?1.14*.62:1.14;i.scale.setScalar(E*rt.lerp(1-k.stage*.42,Te,k.growth)*(1-.2*k.vision)),i.position.set(0,w*(1-k.growth),-k.stage*1.2*(1-k.growth)),Vl.classList.toggle("light-chapter",k.breach>.75&&k.controlIntro<.2||k.dive<.43&&k.wave>0&&G_(k.wave,.5)>1-(Xe.headerBottom||80)*.5/Fi.clientHeight);let je=1-rt.smoothstep(k.breach,.25,.45)*(1-rt.smoothstep(k.breach,.76,.94));j_.style.opacity=String(je),j_.inert=je<.05,ex.style.opacity=String(k.opening),ex.inert=k.opening<.1;let O=(ni[k.active]??ni[0]).detail?k.productDetail:0;sa.style.opacity=String(k.copy),sa.style.setProperty("--product-detail",String(O)),Vh[0].setAttribute("aria-hidden",String(O>.5)),Vh[1].setAttribute("aria-hidden",String(O<=.5));let ge=k.draw>0&&k.visionFade>0&&!yt.matches;aa.style.visibility=ge?"visible":"hidden",aa.style.opacity=String(k.visionFade),aa.inert=!ge,aa.setAttribute("aria-hidden",String(!ge)),oa.style.opacity=String(k.dayHeading),_o.style.opacity=String(k.dayCopy),_o.style.transform=`translateY(${(k.dayActive-k.dayIndex)*innerHeight*.75}px)`,SE.style.opacity=String(k.dayCopy);let Ae=(fr[k.dayActive]??fr[0]).detail?k.dayDetail:0;if(Op.style.opacity=String(1-rt.smoothstep(Ae,0,.45)),Bp.style.opacity=String(rt.smoothstep(Ae,.55,1)),Op.setAttribute("aria-hidden",String(Ae>.5)),Bp.setAttribute("aria-hidden",String(Ae<=.5)),oa.style.visibility=k.dayHeading>0&&!yt.matches?"visible":"hidden",oa.inert=k.dayCopy===0||yt.matches,oa.setAttribute("aria-hidden",String(oa.inert)),A!==k.dayActive){A=k.dayActive;let Ie=fr[A];_o.querySelector("h3").textContent=Ie.title,Op.textContent=Ie.description,Bp.textContent=Ie.detail,_o.querySelector("button").firstChild.textContent=`${Ie.action} `,document.querySelector("#day-count").textContent=`0${A+1} / 0${fr.length}`,document.querySelector("#previous-day").disabled=A===0,document.querySelector("#next-day").disabled=A===fr.length-1,Hh("section",{section:"your_day",scene:A})}let ye=k.controlEnter,ue=k.controlExit,me=ye*(1-ue);Ei.style.opacity=String(k.control),Ei.style.setProperty("--control-photo",String(rt.smoothstep(k.controlIntro,.05,.22))),Ei.style.setProperty("--control-dim",String(k.controlDim)),Ei.style.setProperty("--control-title",String(k.controlTitle)),Ei.style.setProperty("--control-travel",`${k.controlScene*-innerHeight*.95}px`);for(let Ie=0;Ie<3;Ie++){let xt=Math.abs(k.controlBeatIndex-Ie),et=me*(1-rt.smoothstep(xt,.62,.9));Ei.style.setProperty(`--beat-${Ie}`,String(et));let pt=(Ie-k.controlBeatIndex)*innerHeight*.86+(1-ye)*innerHeight*.58-ue*innerHeight*.28;Fp[Ie].style.transform=`translate(-50%, calc(-50% + ${pt}px))`,Fp[Ie].inert=et<.95,Fp[Ie].setAttribute("aria-hidden",String(et<.05))}k.control>.9&&I!==k.controlBeatActive&&(I=k.controlBeatActive,Hh("section",{section:"control",scene:I})),ME.style.opacity=String(rt.smoothstep(k.controlIntro,.05,.22)),Ei.style.visibility=k.control>0&&!yt.matches?"visible":"hidden",Ei.inert=k.control<.9||yt.matches,Ei.setAttribute("aria-hidden",String(Ei.inert)),tx.forEach((Ie,xt)=>{let et=xt/tx.length*.58,pt=rt.smoothstep(k.draw,et,et+.42);Ie.style.strokeDashoffset=String(1-pt)});let Se=1/zp.length;zp.forEach((Ie,xt)=>{let et=rt.clamp((k.visionSequence-xt*Se)/Se,0,1),{opacity:pt,y:It}=Q_(et,xt===zp.length-1);Ie.style.opacity=String(pt),Ie.style.transform=`translateY(${It}px)`,Ie.setAttribute("aria-hidden",String(pt<.1))}),aa.querySelector(".vision-sequence").style.opacity=String(k.explanation),Np.style.opacity=String(rt.smoothstep(k.stage,.85,1)*(1-rt.smoothstep(k.index,ni.length-.95,ni.length-.5)));let qe=k.stage>.95&&k.index<ni.length-.5&&!yt.matches;z!==qe&&(z=qe,sa.inert=!qe,Np.inert=!qe,sa.setAttribute("aria-hidden",String(!qe)),Np.setAttribute("aria-hidden",String(!qe))),P!==k.active&&(P=k.active,sa.querySelector("h2").textContent=ni[P].title,Vh[0].textContent=ni[P].description,Vh[1].textContent=ni[P].detail,document.querySelector("#slide-count").textContent=`0${P+1} / 0${ni.length}`,document.querySelector("#previous-screen").disabled=P===0,document.querySelector("#next-screen").disabled=P===ni.length-1,Hh("product",{scene:P}));let de=-.16+Xe.rotation+_.x*.045*(1-k.growth),Qe=Math.atan2(Math.sin(-de),Math.cos(-de));i.rotation.set((.035+_.y*.04)*(1-k.growth)-.12*k.vision,de+Qe*k.growth+.6*k.vision,-.018*(1-k.growth)-.08*k.vision),t.position.x=_.x*.11*(1-k.growth),t.position.y=.12+_.y*.04*(1-k.growth),t.position.z=10.8,t.lookAt(0,0,0),u.prepare(t,i,k),t.updateMatrixWorld(),o.updateMatrixWorld(),d.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse).multiply(o.matrixWorld);let Oe=d.elements;l.uniforms.uBrandScreenToLocal.value.set(Oe[0],Oe[4],Oe[12],Oe[1],Oe[5],Oe[13],Oe[3],Oe[7],Oe[15]).invert(),k.timelinePixels=ne,u.setPlayback(Xe.playing&&S&&R&&!document.hidden&&!Yi.open),k.control<1&&u.render(r,()=>a.render(r,e,t,k.wave),k,Xe.time),Object.assign(Xe,{dive:k.dive,day:k.day,dayCopy:k.dayCopy,dayStops:x.dayStops,diveStart:x.diveStart,diveEnd:x.diveEnd,dayStart:x.dayStart,daySettled:x.daySettled,cameraPosition:t.position.toArray()}),Object.assign(Xe,{dayIndex:k.dayIndex,dayReadingStops:x.dayReadingStops,dayExitEnd:x.dayExitEnd,breachStart:x.breachStart,breachEnd:x.breachEnd,breach:k.breach,control:k.control,controlScene:k.controlScene,controlIntro:k.controlIntro,controlDim:k.controlDim,controlStop:x.controlStop}),Object.assign(Xe,{controlReadingStops:x.controlReadingStops,controlStart:x.controlStart,controlEnd:x.controlEnd,dayDetail:Ae,videoPlayback:u.videoState()}),Object.assign(Xe,{readingHold:U.active?.id??null,readingStops:x.readingStops,videoLocked:F.active,dayPlaybackStops:x.dayPlaybackStops,nativeEnd:x.nativeEnd}),Object.assign(Xe,{renders:Xe.renders+1,yaw:i.rotation.y,scrollPixels:ae,timelinePixels:ne,scrollRange:$,growth:k.growth,wave:k.wave,vision:k.vision,draw:k.draw,gridTravel:k.gridTravel,visionStops:x.visionStops,visionStart:x.visionStart,visionEnd:x.visionEnd,finaleStops:x.finaleStops,waveStart:x.waveStart,waveEnd:x.waveEnd,exitEnd:x.exitEnd,wordmarkOpacity:k.opening,tutorOpacity:k.tutor,tutorOverlayOpacity:oe,tutorOverlayY:J,tutorOverlayScale:te,tutorOffset:l.uniforms.uTutorOffset.value.toArray(),tutorSequenceProgress:D.progress,tutorSequenceActive:D.active,carousel:k.stage,carouselIndex:k.index,activeSlide:P,checkInOpacity:c.panels[0].detailMesh?.material.opacity??0,lobbyOpacity:c.panels[0].mesh.material.opacity,textExit:x.textExit,carouselStart:x.carouselStart,stops:x.stops,textRightEdge:k.x+x.tutorWidth/2,width:Fi.clientWidth,height:Fi.clientHeight,triangles:r.info.render.triangles}),y=We,Y=ne}function he(){Br.innerHTML=document.querySelector(Xe.playing?"#pause-icon":"#play-icon").innerHTML;let $=yt.matches?"Motion disabled by reduced-motion preference":Xe.playing?"Pause motion":"Play motion";Br.setAttribute("aria-label",$),Br.title=$,Br.setAttribute("aria-pressed",String(!Xe.playing)),Br.disabled=yt.matches}function fe($){if(p=0,!Xe.playing||!S||document.hidden||!Xe.ready)return;let ie=Math.max(0,($-g)/1e3);g=$;let Re=Math.min(ie,.1);L.push(ie*1e3),L.length>120&&L.shift(),Xe.time+=Re,Xe.rotating&&!Xe.finalizing&&(Xe.rotation+=Math.PI*2/28*Re),_.lerp(m,1-Math.exp(-6*Re)),K(),p=requestAnimationFrame(fe)}function ve(){p||!Xe.playing||!S||document.hidden||!Xe.ready||(g=performance.now(),p=requestAnimationFrame(fe))}function Ve(){cancelAnimationFrame(p),p=0,u.setPlayback(!1),Xe.videoPlayback=u.videoState()}function De(){Xe.playing=!1,U.cancel(),Ve(),he()}function Ze(){let $=Fi.clientWidth,ie=Fi.clientHeight;t.aspect=$/ie,t.updateProjectionMatrix();let Re=Math.min(devicePixelRatio,Up.matches?1.5:1.25);r.setPixelRatio(Re),r.setSize($,ie,!1),a.resize($,ie,Re),u.resize($,ie,Re);let ae=2*Math.tan(rt.degToRad(16))*10.8,We=ae*t.aspect,R=$<700,v=document.querySelector(".hero-footer").offsetTop,V=document.querySelector(".header").offsetHeight,Q=R?Math.min(v,ie-(ie<680?252:268)):v,ne=(V+Q)/2,k=Math.max(150,Q-V-48),oe=Math.min(.87,We/(R?5.5:5.1),k/ie*ae/4.45);E=oe,w=(.5-ne/ie)*ae,i.scale.setScalar(oe),i.position.y=w;let J=k/ie*ae*4,te=Math.min(We*(R?.95:.895),J)*(10.8+1.8)/10.8*.9;o.scale.set(te,te/4,1),o.position.set(0,i.position.y*(10.8+1.8)/10.8,-1.8);let we=$<ie,Ce=we?56:48,_e=2*Math.tan(rt.degToRad(16))/Math.tan(rt.degToRad(Ce/2));l.mesh.scale.set(_e,_e,2),l.mesh.position.z=10.8-24,l.uniforms.uMobile.value=$<=960||we?1:0,l.uniforms.uPitch.value=R?.032:.045,l.uniforms.uSpan.value=2*Math.tan(rt.degToRad(Ce/2))*12*t.aspect,l.uniforms.uTextCenter.value=i.position.y*24/10.8/_e,l.uniforms.uCopyBottom.value=1-v/ie,l.uniforms.uCopyTop.value=1-V/ie;let xe=l.uniforms.uSpan.value,Te=l.uniforms.uMobile.value?xe*.84*.68:16*.45;if(x=V_({height:innerHeight,span:xe,tutorWidth:Te}),Ms){Ms.style.setProperty("--tutor-font-size","100px");let it=100*Math.max(280,$-(R?24:36))/Math.max(1,Ms.scrollWidth);Ms.style.setProperty("--tutor-font-size",`${it}px`)}qi.style.setProperty("--scroll-distance",`${x.nativeEnd}px`),c.resize({width:$,height:ie,headerBottom:V,copyTop:sa.offsetTop}),Object.assign(Xe,{symbolScale:oe,focalCenter:ne,headerBottom:V,footerTop:v}),K(),M&&(cancelAnimationFrame(C),C=requestAnimationFrame(()=>{ot.refresh(),K()}))}Br.addEventListener("click",()=>{yt.matches||(Xe.playing?De():(Xe.playing=!0,he(),ve()))}),Vl.addEventListener("pointermove",$=>{if(!Xe.playing||yt.matches||!Up.matches||$.pointerType!=="mouse")return;let ie=Vl.getBoundingClientRect();m.set(($.clientX/ie.width-.5)*2,(.5-($.clientY-ie.top)/ie.height)*2)}),Vl.addEventListener("pointerleave",()=>m.set(0,0));function be(){M?.scrollTrigger?.kill(),M?.kill(),H.progress=0,document.body.classList.toggle("motion-ready",!yt.matches&&Xe.ready),!yt.matches&&Xe.ready&&(M=mh.fromTo(H,{progress:0},{progress:1,ease:"none",scrollTrigger:{trigger:qi,start:"top top",end:"bottom bottom",scrub:.38},onUpdate:()=>{K()}}),ot.refresh()),K()}function j($){let ie=$>=x.textExit?Math.max(0,x.textExit-x.tutorLockStart):0;return qi.offsetTop+$-ie}function ce($,ie){location.hash!==$&&history.pushState(null,"",$),Be(),D.complete=ie>qi.offsetTop+x.tutorLockStart,Y=ie-qi.offsetTop+(D.complete?x.textExit-x.tutorLockStart:0),b=!0,window.scrollTo({top:ie,behavior:"instant"}),M?.scrollTrigger?.update(),K()}function se($){let ie=j(x.stops[rt.clamp($,0,ni.length-1)]);window.scrollTo({top:ie,behavior:yt.matches?"instant":"smooth"})}document.querySelectorAll('a[href="#homework"]').forEach($=>$.addEventListener("click",ie=>{!Xe.ready||yt.matches||(ie.preventDefault(),ce("#homework",j(x.stops[0])))})),document.querySelector("#previous-screen").addEventListener("click",()=>se(P-1)),document.querySelector("#next-screen").addEventListener("click",()=>se(P+1)),document.querySelector("#inspect-screen").addEventListener("click",()=>Gh(P)),document.querySelector("#inspect-day").addEventListener("click",()=>Gh(A,!0));function B($){window.scrollTo({top:j(x.dayReadingStops[rt.clamp($,0,fr.length-1)]),behavior:yt.matches?"instant":"smooth"})}document.querySelector("#previous-day").addEventListener("click",()=>B(A-1)),document.querySelector("#next-day").addEventListener("click",()=>B(A+1)),document.querySelectorAll('a[href="#your-day"]').forEach($=>$.addEventListener("click",ie=>{ie.preventDefault(),yt.matches||!Xe.ready?document.querySelector(".fallback-day-heading").scrollIntoView():ce("#your-day",j(x.dayReadingStops[0]))})),document.querySelectorAll(".questions details").forEach($=>$.addEventListener("toggle",()=>ot.refresh())),document.querySelectorAll('a[href="#your-control"]').forEach($=>$.addEventListener("click",ie=>{ie.preventDefault(),yt.matches||!Xe.ready?la.scrollIntoView():ce("#your-control",j(x.controlStop))}));let pe=document.querySelector(".closing");document.querySelectorAll('a[href="#waitlist"]').forEach($=>$.addEventListener("click",ie=>{ie.preventDefault(),ce("#waitlist",pe.getBoundingClientRect().top+scrollY)})),document.querySelectorAll('a[href="#opening"]').forEach($=>$.addEventListener("click",ie=>{ie.preventDefault(),ce("#opening",0)}));function Ge($){pe.style.setProperty("--closing-progress",String($));for(let ie=0;ie<5;ie++){let Re=rt.clamp(($-(.42+ie*.045))/.28,0,1);pe.style.setProperty(`--letter-${ie}-alpha`,String(Re)),pe.style.setProperty(`--letter-${ie}-clip`,`${(1-Re)*100}%`)}}let N=ot.create({trigger:pe,start:"top bottom",end:"bottom bottom",onUpdate:$=>{Ge(yt.matches?1:$.progress)}});Xe.closingMotion=N,Ge(yt.matches?1:N.progress),yt.addEventListener("change",()=>{Be(),Xe.reducedMotion=yt.matches,De(),_.set(0,0),m.set(0,0),Xe.rotating=!yt.matches,yt.matches&&(Xe.time=0,Xe.rotation=0),Ge(yt.matches?1:N.progress),be(),he()}),Up.addEventListener("change",()=>{_.set(0,0),m.set(0,0),Ze()}),new ResizeObserver(Ze).observe(Vl),new IntersectionObserver($=>{S=$[0].isIntersecting,S?ve():Ve()},{threshold:0}).observe(qi),document.addEventListener("visibilitychange",()=>{document.hidden?Ve():ve()}),Fi.addEventListener("webglcontextlost",$=>{Be(),$.preventDefault(),Ve(),Xe.ready=!1,M?.scrollTrigger?.kill(),M?.kill(),document.body.classList.remove("ready","motion-ready")}),Fi.addEventListener("webglcontextrestored",()=>{Ze(),Xe.ready=!0,document.body.classList.add("ready"),be(),ve()}),Xe.seek=$=>{De(),Xe.time=Math.max(0,Number($)||0),_.set(0,0),m.set(0,0),K()},Xe.setAngle=$=>{De(),Xe.rotation=Number($)+.16,_.set(0,0),m.set(0,0),K()},Xe.play=()=>{yt.matches||(Xe.playing=!0,he(),ve())},Xe.redraw=K,Xe.performance=()=>({samples:L.length,meanFrameMs:L.reduce(($,ie)=>$+ie,0)/Math.max(1,L.length),drawCalls:r.info.render.calls,triangles:r.info.render.triangles}),Xe.goToSlide=se,Xe.goToDay=B,Xe.layers={wall:!0,wordmark:!0,symbol:!0},Xe.showLayer=($,ie)=>{let Re={wall:l.mesh,wordmark:o,symbol:i}[$];Re&&(Re.visible=ie,Xe.layers[$]=ie,K())},Ze(),Xe.ready=!0,he(),document.body.classList.add("ready"),be(),ve()}bE().catch(r=>{Xe.error=String(r),document.body.classList.remove("ready","motion-ready"),Br.disabled=!0,Br.title="Motion unavailable",Br.setAttribute("aria-label","Motion unavailable")});})();
