...
export const FEATURES: FeatureMeta[] = [
  ...
  { slug: "F7", path: "/reminders", title: "Smart reminders", summary: "Quiet hours, no-weekend rule, escalating only when a task is long past its due date.", slice: 3, status: "stub" },
  ...
  { slug: "F11", path: "/shame-mode", title: "Anti-shame mode", summary: "Reframes late tasks without piling on. No red, no exclamation marks.", slice: 4, status: "stub" },
  ...
  { slug: "F17", path: "/insights", title: "Insights", summary: "Patterns in your week (when you focus best, where you stall).", slice: 5, status: "live" },
  ...
  { slug: "F19", path: "/export", title: "Take your data", summary: "One-click JSON export, account deletion.", slice: 6, status: "live" },
