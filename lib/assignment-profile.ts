...
const SUBJECT_RULES: readonly SubjectRule[] = [
  ...
  { domain: "music", pattern: /\b(music theory|music notation|musicxml|musical composition|orchestra|band|choir|sight reading|musical score)\b/iu, capabilities: ["music_notation", "audio_review", "performance_log", "rich_text"], artifactType: "music_score", intents: ["perform", "practice", "reflect"], safetyClass: "minor_media", legacyMode: "art" },
  ...
  { domain: "science", pattern: /\b(biology|chemistry|physics|earth science|environmental science|biometrics?|biostatistics?|bioinformatics?|computational biology|epidemiology|laboratory|experiment)\b/iu, capabilities: ["procedure_checklist", "data_lab", "equation_editor", "graphing", "spreadsheet", "rich_text"], artifactType: "lab_report", intents: ["experiment", "record_data", "calculate", "explain"], safetyClass: "lab_hazard", legacyMode: "lab" },
