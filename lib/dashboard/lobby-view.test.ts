...
function assignment(
  ...
  return {
    ...
    created_at: values.created_at ?? "2026-09-01T12:00:00.000Z",
    ai_mode_override: values.ai_mode_override ?? null,
    classes: values.classes ?? { name: "English", color: "#2dd4bf", ai_mode: "green" },
