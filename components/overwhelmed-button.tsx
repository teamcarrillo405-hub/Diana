  ...
  return (
    <div className={placement === "inline" ? "relative" : "fixed bottom-6 right-6 z-50"}>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {childId && (
              <Link
                ...
                className="diana-button diana-button-primary touch-target rounded-xl px-3 py-2 text-sm font-medium"
              >
                Open next step
              </Link>
            )}
      ...
      <button
        ...
        onClick={activate}
        disabled={pending}
        className="diana-button diana-button-secondary inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-full px-3 py-2 text-sm font-semibold disabled:opacity-50 md:min-h-12 md:w-auto md:px-4 md:py-3"
      >
        <LifeBuoy size={18} />
        I&apos;m stuck
      </button>
