...
export function AgentFab() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: "coach", content: OPENING_MESSAGE },
  ]);
      ...
      {!open && (
        ...
        >
          {hover && (
            <div
              style={{
                animation: "af-in .35s ease both",
                padding: "9px 14px",
                borderRadius: 11,
                background: "rgba(6,10,24,.92)",
                border: "1px solid rgba(41,208,255,.3)",
          ...
          <button
            ...
            style={{
              ...
              position: "relative",
              background:
                "radial-gradient(circle at 32% 28%,#151d34,#060911 70%)",
          ...
          >
            ...
            <img
              ...
              style={{
                ...
                borderRadius: "50%",
                filter: "drop-shadow(0 0 6px rgba(41,208,255,.5))",
              }}
            />
            <span
              aria-hidden="true"
      ...
      {open && (
        <div
          style={{
            ...
            flexDirection: "column",
            background:
              "linear-gradient(180deg,rgba(8,12,26,.97),rgba(12,18,42,.97))",
            borderLeft: "1px solid rgba(41,208,255,.25)",
            boxShadow: "-30px 0 70px rgba(0,0,0,.55)",
          }}
        >
          <div
            style={{
              ...
              gap: 11,
              padding: "16px 18px",
              borderBottom: "1px solid rgba(120,150,220,.18)",
            }}
          >
            <div
              style={{
                ...
                border: "1px solid rgba(41,208,255,.25)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                flexShrink: 0,
            ...
            >
              ...
              <img
                ...
                style={{
                  ...
                  objectPosition: "50% 15%",
                  borderRadius: "50%",
                  filter: "drop-shadow(0 0 5px rgba(41,208,255,.5))",
                }}
              />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 11.5, color: "#7d88ad" }}>
                Coach, not answers
              </div>
            </div>
            <button
              ...
              m.role === "coach" ? (
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(41,208,255,.18)",
                    background: "rgba(41,208,255,.08)",
                    padding: "10px 13px",
                    fontSize: 14,
                    lineHeight: 1.55,
                    color: "#cdd6f2",
              ...
              >
                <span
                  style={{
                    ...
                    borderRadius: "50%",
                    background: "#29d0ff",
                    animation: "af-dot 1.2s infinite",
                  }}
                />
                <span
                  style={{
                    ...
                    borderRadius: "50%",
                    background: "#29d0ff",
                    animation: "af-dot 1.2s .2s infinite",
                  }}
                />
                <span
                  style={{
                    ...
                    borderRadius: "50%",
                    background: "#29d0ff",
                    animation: "af-dot 1.2s .4s infinite",
                  }}
                />
              </div>
            )}
