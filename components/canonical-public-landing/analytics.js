...
export const landingAnalyticsEvents = Object.freeze({
  ...
  waitlistFailed: 'landing_waitlist_failed',
  productMediaEngaged: 'landing_product_media_engaged',
  storySkipped: 'landing_story_skipped',
})
...
const EVENT_PROPERTIES = Object.freeze({
  ...
  [landingAnalyticsEvents.waitlistFailed]: {
    location: new Set(['final']),
  },
  [landingAnalyticsEvents.productMediaEngaged]: {
    scene: new Set(['lobby', 'work', 'coaching', 'practice', 'calendar', 'connections', 'notes', 'life']),
  },
  [landingAnalyticsEvents.storySkipped]: {
    destination: new Set(['product_proof', 'your_day', 'control', 'questions', 'early_access']),
  },
})
